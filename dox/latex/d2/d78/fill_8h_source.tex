\doxysection{fill.\+h}
\hypertarget{fill_8h_source}{}\label{fill_8h_source}\index{include/srsran/srsvec/fill.h@{include/srsran/srsvec/fill.h}}
...
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{comment}{///\ \(\backslash\)brief\ Sets\ all\ elements\ of\ a\ sequence\ to\ a\ given\ value.}}
...
\DoxyCodeLine{00035\ \textcolor{comment}{///\ \(\backslash\)param\ \ value\ \ Value\ the\ sequence\ is\ set\ to.\ Must\ be\ compatible\ with\ the\ element\ type\ of\ the\ sequence.}}
\DoxyCodeLine{00036\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00037\ \textcolor{keywordtype}{void}\ fill(T\&\&\ x,\ detail::value\_type\_of\_t<T>\ value)}
\DoxyCodeLine{00038\ \{}
\DoxyCodeLine{00039\ \ \ \textcolor{keyword}{static\_assert}(detail::is\_span\_compatible<T>::value,\ \textcolor{stringliteral}{"{}Template\ type\ is\ not\ compatible\ with\ a\ span"{}});}
\DoxyCodeLine{00040\ \ \ std::fill(x.begin(),\ x.end(),\ value);}
\DoxyCodeLine{00041\ \}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \}\ \textcolor{comment}{//\ namespace\ srsvec}}
