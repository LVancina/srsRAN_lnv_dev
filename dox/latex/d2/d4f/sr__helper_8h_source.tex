\doxysection{sr\+\_\+helper.\+h}
\hypertarget{sr__helper_8h_source}{}\label{sr__helper_8h_source}\index{lib/scheduler/support/sr\_helper.h@{lib/scheduler/support/sr\_helper.h}}
...
\DoxyCodeLine{00028\ \textcolor{keyword}{namespace}\ sr\_helper\ \{}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{comment}{///\ \(\backslash\)brief\ Helpers\ that\ checks\ if\ the\ slot\ is\ a\ candidate\ for\ SR\ reporting\ for\ a\ given\ user.}}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{bool}\ is\_sr\_opportunity\_slot(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1pucch__config}{pucch\_config}}\&\ pucch\_cfg,\ \mbox{\hyperlink{classsrsran_1_1slot__point}{slot\_point}}\ sl\_tx);}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \}\ \textcolor{comment}{//\ namespace\ sr\_helper}}
