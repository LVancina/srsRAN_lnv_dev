\doxysection{csi\+\_\+report\+\_\+helpers.\+h}
\hypertarget{csi__report__helpers_8h_source}{}\label{csi__report__helpers_8h_source}\index{lib/scheduler/support/csi\_report\_helpers.h@{lib/scheduler/support/csi\_report\_helpers.h}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#}\textcolor{preprocessor}{include}\ \textcolor{preprocessor}{"{}srsran/scheduler/config/serving\_cell\_config.h"{}}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{namespace}\ \mbox{\hyperlink{namespacesrsran}{srsran}}\ \{}
\DoxyCodeLine{00028\ \textcolor{keyword}{namespace}\ csi\_helper\ \{}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{comment}{///\ \(\backslash\)brief\ Helpers\ that\ checks\ if\ the\ slot\ is\ a\ candidate\ for\ CSI\ reporting\ for\ a\ given\ user.}}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{bool}\ is\_csi\_reporting\_slot(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1serving__cell__config}{serving\_cell\_config}}\&\ ue\_cfg,\ \mbox{\hyperlink{classsrsran_1_1slot__point}{slot\_point}}\ sl\_tx);}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \}\ \textcolor{comment}{//\ namespace\ csi\_helper}}
