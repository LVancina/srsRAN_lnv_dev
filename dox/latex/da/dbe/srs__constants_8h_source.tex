\doxysection{srs\+\_\+constants.\+h}
\hypertarget{srs__constants_8h_source}{}\label{srs__constants_8h_source}\index{include/srsran/ran/srs/srs\_constants.h@{include/srsran/ran/srs/srs\_constants.h}}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{namespace}\ srs\_constants\ \{}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{comment}{///\ Maximum\ number\ of\ transmit\ ports\ that\ can\ transmit\ Sounding\ Reference\ Signals\ (SRS).}}
\DoxyCodeLine{00030\ \textcolor{keyword}{static}\ \textcolor{keyword}{constexpr}\ \textcolor{keywordtype}{unsigned}\ max\_nof\_tx\_ports\ =\ 4;}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{comment}{///\ Maximum\ number\ of\ receive\ ports\ that\ can\ be\ used\ to\ receive\ Sounding\ Reference\ Signals\ (SRS).}}
\DoxyCodeLine{00033\ \textcolor{keyword}{static}\ \textcolor{keyword}{constexpr}\ \textcolor{keywordtype}{unsigned}\ max\_nof\_rx\_ports\ =\ 4;}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \}\ \textcolor{comment}{//\ namespace\ srs\_constants}}
\DoxyCodeLine{00036\ }
