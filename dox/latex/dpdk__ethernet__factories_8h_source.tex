...
\DoxyCodeLine{00037\ \textcolor{keyword}{struct\ }gw\_config;}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00040\ std::pair<std::unique\_ptr<gateway>,\ std::unique\_ptr<receiver>>}
\DoxyCodeLine{00041\ create\_dpdk\_txrx(\textcolor{keyword}{const}\ gw\_config\&\ config,\ task\_executor\&\ rx\_executor,\ \mbox{\hyperlink{classsrslog_1_1detail_1_1logger__impl}{srslog::basic\_logger}}\&\ logger);}
\DoxyCodeLine{00042\ }
