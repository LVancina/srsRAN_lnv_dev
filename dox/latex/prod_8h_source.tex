...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keywordtype}{void}\ prod(span<const\ cf\_t>\ x,\ span<const\ cf\_t>\ y,\ span<cf\_t>\ z);}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{void}\ prod(span<const\ cf\_t>\ x,\ span<const\ float>\ y,\ span<cf\_t>\ z);}
\DoxyCodeLine{00032\ \textcolor{keywordtype}{void}\ prod(span<const\ float>\ x,\ span<const\ cf\_t>\ y,\ span<cf\_t>\ z);}
\DoxyCodeLine{00033\ \textcolor{keywordtype}{void}\ prod(span<const\ float>\ x,\ span<const\ float>\ y,\ span<float>\ z);}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{keywordtype}{void}\ prod\_conj(span<const\ cf\_t>\ x,\ span<const\ cf\_t>\ y,\ span<cf\_t>\ z);}
\DoxyCodeLine{00036\ }
