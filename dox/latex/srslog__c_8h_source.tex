...
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00067\ srslog\_log\_channel*\ srslog\_fetch\_log\_channel(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00073\ srslog\_log\_channel*\ srslog\_find\_log\_channel(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{00074\ }
...
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00102\ srslog\_logger*\ srslog\_fetch\_default\_logger(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{00103\ }
\DoxyCodeLine{00108\ srslog\_logger*\ srslog\_find\_default\_logger(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{00109\ }
...
\DoxyCodeLine{00127\ \ \ srslog\_lvl\_none,\ \ \ \ }
\DoxyCodeLine{00128\ \ \ srslog\_lvl\_error,\ \ \ }
\DoxyCodeLine{00129\ \ \ srslog\_lvl\_warning,\ }
\DoxyCodeLine{00130\ \ \ srslog\_lvl\_info,\ \ \ \ }
\DoxyCodeLine{00131\ \ \ srslog\_lvl\_debug\ \ \ \ }
...
\DoxyCodeLine{00138\ }
\DoxyCodeLine{00143\ srslog\_sink*\ srslog\_find\_sink(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{00144\ }
...
\DoxyCodeLine{00154\ }
\DoxyCodeLine{00163\ srslog\_sink*\ srslog\_fetch\_file\_sink(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ path,\ \textcolor{keywordtype}{size\_t}\ max\_size,\ srslog\_bool\ force\_flush);}
\DoxyCodeLine{00164\ }
