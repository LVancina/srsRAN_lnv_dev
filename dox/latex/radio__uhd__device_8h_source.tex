...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#include\ "{}radio\_uhd\_device\_type.h"{}}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#include\ "{}radio\_uhd\_exception\_handler.h"{}}}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ "{}radio\_uhd\_rx\_stream.h"{}}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#include\ "{}radio\_uhd\_tx\_stream.h"{}}}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#include\ "{}srsran/radio/radio\_session.h"{}}}
\DoxyCodeLine{00030\ }
...
\DoxyCodeLine{00044\ \{}
\DoxyCodeLine{00045\ \ \ int64\_t\ clipped\_gain\ =\ \textcolor{keyword}{static\_cast<}uint64\_t\textcolor{keyword}{>}(std::round(range.clip(gain,\ \textcolor{keyword}{true})\ *\ 100));}
\DoxyCodeLine{00046\ \ \ int64\_t\ uint\_gain\ \ \ \ =\ \textcolor{keyword}{static\_cast<}uint64\_t\textcolor{keyword}{>}(gain\ *\ 100);}
\DoxyCodeLine{00047\ }
...
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classsrsran_1_1radio__uhd__device}{radio\_uhd\_device}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classsrsran_1_1uhd__exception__handler}{uhd\_exception\_handler}}}
\DoxyCodeLine{00059\ \{}
\DoxyCodeLine{00060\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00061\ \ \ \mbox{\hyperlink{classsrsran_1_1radio__uhd__device}{radio\_uhd\_device}}()\ :\ logger(srslog::fetch\_basic\_logger(\textcolor{stringliteral}{"{}RF"{}}))\ \{\}}
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \ \ \textcolor{keywordtype}{bool}\ is\_valid()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ usrp\ !=\ \textcolor{keyword}{nullptr};\ \}}
\DoxyCodeLine{00064\ }
...
\DoxyCodeLine{00077\ \ \ \ \ \textcolor{keywordflow}{if}\ (not\ device\_addr.has\_key(\textcolor{stringliteral}{"{}type"{}}))\ \{}
...
\DoxyCodeLine{00100\ \ \ \ \ \ \ type\ =\ \mbox{\hyperlink{classsrsran_1_1radio__uhd__device__type}{radio\_uhd\_device\_type}}(device\_addr.get(\textcolor{stringliteral}{"{}type"{}}));}
\DoxyCodeLine{00101\ }
...
\DoxyCodeLine{00165\ \ \ \ \ \ \ \ \ usb\_version\ =\ usrp-\/>get\_device()-\/>get\_tree()-\/>access<unsigned>(\textcolor{stringliteral}{"{}/mboards/0/usb\_version"{}}).get();}
\DoxyCodeLine{00166\ \ \ \ \ \ \ \});}
\DoxyCodeLine{00167\ }
...
\DoxyCodeLine{00220\ \ \ \}}
\DoxyCodeLine{00221\ \ \ \textcolor{keywordtype}{bool}\ set\_sync\_source(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1clock__sources}{radio\_configuration::clock\_sources}}\&\ config)}
\DoxyCodeLine{00222\ \ \ \{}
\DoxyCodeLine{00223\ \ \ \ \ \textcolor{comment}{//\ Convert\ clock\ source\ to\ string.}}
\DoxyCodeLine{00224\ \ \ \ \ std::string\ clock\_src;}
\DoxyCodeLine{00225\ \ \ \ \ \textcolor{keywordflow}{switch}\ (config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1clock__sources_acdbb9d533b08584565dffe125a417d99}{clock}})\ \{}
...
\DoxyCodeLine{00240\ \ \ \ \ \textcolor{keywordflow}{switch}\ (config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1clock__sources_a82f1444146a0c588cc84cee172222a4c}{sync}})\ \{}
...
\DoxyCodeLine{00263\ \ \ \ \ \ \ \ \ on\_error(\textcolor{stringliteral}{"{}Invalid\ clock\ source\ \{\}.\ Supported:\ \{\}"{}},\ clock\_src,\ \mbox{\hyperlink{classsrsran_1_1span}{span<const\ std::string>}}(clock\_sources));}
...
\DoxyCodeLine{00311\ \ \ \}}
\DoxyCodeLine{00312\ \ \ std::unique\_ptr<radio\_uhd\_tx\_stream>\ create\_tx\_stream(\mbox{\hyperlink{classsrsran_1_1task__executor}{task\_executor}}\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ async\_executor,}
\DoxyCodeLine{00313\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classsrsran_1_1radio__notification__handler}{radio\_notification\_handler}}\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ notifier,}
\DoxyCodeLine{00314\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1radio__uhd__tx__stream_1_1stream__description}{radio\_uhd\_tx\_stream::stream\_description}}\&\ description)}
\DoxyCodeLine{00315\ \ \ \{}
...
\DoxyCodeLine{00324\ \ \ \}}
\DoxyCodeLine{00325\ \ \ std::unique\_ptr<radio\_uhd\_rx\_stream>\ create\_rx\_stream(\mbox{\hyperlink{classsrsran_1_1radio__notification__handler}{radio\_notification\_handler}}\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ notifier,}
\DoxyCodeLine{00326\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1radio__uhd__rx__stream_1_1stream__description}{radio\_uhd\_rx\_stream::stream\_description}}\&\ description)}
\DoxyCodeLine{00327\ \ \ \{}
...
\DoxyCodeLine{00332\ \ \ \ \ \}}
\DoxyCodeLine{00333\ }
\DoxyCodeLine{00334\ \ \ \ \ printf(\textcolor{stringliteral}{"{}Error:\ failed\ to\ create\ receive\ stream\ \%d.\ \%s."{}},\ description.\mbox{\hyperlink{structsrsran_1_1radio__uhd__rx__stream_1_1stream__description_ab9e55f09b4a0a0f745a8cf6d7d50db27}{id}},\ stream-\/>get\_error\_message().c\_str());}
...
\DoxyCodeLine{00354\ \ \ \ \ \});}
\DoxyCodeLine{00355\ \ \ \}}
\DoxyCodeLine{00356\ \ \ \textcolor{keywordtype}{bool}\ set\_rx\_gain(\textcolor{keywordtype}{size\_t}\ ch,\ \textcolor{keywordtype}{double}\ gain)}
\DoxyCodeLine{00357\ \ \ \{}
...
\DoxyCodeLine{00373\ \ \ \ \ \});}
\DoxyCodeLine{00374\ \ \ \}}
\DoxyCodeLine{00375\ \ \ \textcolor{keywordtype}{bool}\ set\_tx\_freq(uint32\_t\ ch,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency}{radio\_configuration::lo\_frequency}}\&\ config)}
\DoxyCodeLine{00376\ \ \ \{}
\DoxyCodeLine{00377\ \ \ \ \ logger.debug(\textcolor{stringliteral}{"{}Setting\ channel\ \{\}\ Tx\ frequency\ to\ \{\}\ MHz."{}},\ ch,\ to\_MHz(config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_a776500655e00f8e389bce04557e544d8}{center\_frequency\_hz}}));}
\DoxyCodeLine{00378\ }
...
\DoxyCodeLine{00381\ }
\DoxyCodeLine{00382\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!radio\_uhd\_device\_validate\_freq\_range(range,\ config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_a776500655e00f8e389bce04557e544d8}{center\_frequency\_hz}}))\ \{}
...
\DoxyCodeLine{00390\ \ \ \ \ \ \ uhd::tune\_request\_t\ tune\_request(config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_a776500655e00f8e389bce04557e544d8}{center\_frequency\_hz}});}
\DoxyCodeLine{00391\ }
...
\DoxyCodeLine{00393\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (std::isnormal(config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_aa166c8b622cf4f37d385df12d43a9559}{lo\_frequency\_hz}}))\ \{}
\DoxyCodeLine{00394\ \ \ \ \ \ \ \ \ tune\_request.rf\_freq\ \ \ \ \ \ \ \ \ =\ config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_aa166c8b622cf4f37d385df12d43a9559}{lo\_frequency\_hz}};}
...
\DoxyCodeLine{00400\ \ \ \ \ \});}
\DoxyCodeLine{00401\ \ \ \}}
\DoxyCodeLine{00402\ \ \ \textcolor{keywordtype}{bool}\ set\_rx\_freq(uint32\_t\ ch,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency}{radio\_configuration::lo\_frequency}}\&\ config)}
\DoxyCodeLine{00403\ \ \ \{}
\DoxyCodeLine{00404\ \ \ \ \ logger.debug(\textcolor{stringliteral}{"{}Setting\ channel\ \{\}\ Rx\ frequency\ to\ \{\}\ MHz."{}},\ ch,\ to\_MHz(config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_a776500655e00f8e389bce04557e544d8}{center\_frequency\_hz}}));}
\DoxyCodeLine{00405\ }
...
\DoxyCodeLine{00408\ }
\DoxyCodeLine{00409\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!radio\_uhd\_device\_validate\_freq\_range(range,\ config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_a776500655e00f8e389bce04557e544d8}{center\_frequency\_hz}}))\ \{}
...
\DoxyCodeLine{00417\ \ \ \ \ \ \ uhd::tune\_request\_t\ tune\_request(config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_a776500655e00f8e389bce04557e544d8}{center\_frequency\_hz}});}
\DoxyCodeLine{00418\ }
...
\DoxyCodeLine{00420\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (std::isnormal(config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_aa166c8b622cf4f37d385df12d43a9559}{lo\_frequency\_hz}}))\ \{}
\DoxyCodeLine{00421\ \ \ \ \ \ \ \ \ tune\_request.rf\_freq\ \ \ \ \ \ \ \ \ =\ config.\mbox{\hyperlink{structsrsran_1_1radio__configuration_1_1lo__frequency_aa166c8b622cf4f37d385df12d43a9559}{lo\_frequency\_hz}};}
...
\DoxyCodeLine{00431\ \ \ uhd::usrp::multi\_usrp::sptr\ usrp\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00432\ \ \ \mbox{\hyperlink{classsrsran_1_1radio__uhd__device__type}{radio\_uhd\_device\_type}}\ \ \ \ \ \ \ type\ =\ \mbox{\hyperlink{classsrsran_1_1radio__uhd__device__type_a89fef702251e27c3e616fa7654d56fdaa696b031073e74bf2cb98e5ef201d4aa3}{radio\_uhd\_device\_type::types::UNKNOWN}};}
\DoxyCodeLine{00433\ \ \ \mbox{\hyperlink{classsrslog_1_1detail_1_1logger__impl}{srslog::basic\_logger}}\&\ \ \ \ \ \ \ logger;}
\DoxyCodeLine{00434\ \};}
\DoxyCodeLine{00435\ }
