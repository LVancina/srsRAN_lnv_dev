...
\DoxyCodeLine{00087\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (from\ >\ \textcolor{keyword}{static\_cast<}From\textcolor{keyword}{>}((T::max)()))\ \{}
...
\DoxyCodeLine{00100\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (from\ >\ \textcolor{keyword}{static\_cast<}From\textcolor{keyword}{>}((T::max)()))\ \{}
...
\DoxyCodeLine{00109\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}To\textcolor{keyword}{>}(from);}
\DoxyCodeLine{00110\ }
...
\DoxyCodeLine{00114\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_same<From,\ To>::value)>}
\DoxyCodeLine{00115\ FMT\_CONSTEXPR\ To\ lossless\_integral\_conversion(\textcolor{keyword}{const}\ From\ from,\ \textcolor{keywordtype}{int}\&\ ec)\ \{}
...
\DoxyCodeLine{00136\ FMT\_CONSTEXPR\ To\ safe\_float\_conversion(\textcolor{keyword}{const}\ From\ from,\ \textcolor{keywordtype}{int}\&\ ec)\ \{}
...
\DoxyCodeLine{00145\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}To\textcolor{keyword}{>}(from);}
\DoxyCodeLine{00146\ \ \ \ \ \}}
...
\DoxyCodeLine{00153\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}To\textcolor{keyword}{>}(from);}
...
\DoxyCodeLine{00157\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_same<From,\ To>::value)>}
\DoxyCodeLine{00158\ FMT\_CONSTEXPR\ To\ safe\_float\_conversion(\textcolor{keyword}{const}\ From\ from,\ \textcolor{keywordtype}{int}\&\ ec)\ \{}
...
\DoxyCodeLine{00168\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_integral<FromRep>::value),}
\DoxyCodeLine{00169\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_integral<typename\ To::rep>::value)>}
...
\DoxyCodeLine{00177\ \ \ \ \ \ \ :\ std::ratio\_divide<typename\ From::period,\ typename\ To::period>\ \{\};}
\DoxyCodeLine{00178\ }
...
\DoxyCodeLine{00229\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_floating\_point<FromRep>::value),}
\DoxyCodeLine{00230\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_floating\_point<typename\ To::rep>::value)>}
...
\DoxyCodeLine{00237\ \ \ \ \ \textcolor{keywordflow}{return}\ To\{std::numeric\_limits<typename\ To::rep>::quiet\_NaN()\};}
\DoxyCodeLine{00238\ \ \ \}}
...
\DoxyCodeLine{00250\ \ \ \ \ \ \ :\ std::ratio\_divide<typename\ From::period,\ typename\ To::period>\ \{\};}
\DoxyCodeLine{00251\ }
...
\DoxyCodeLine{00274\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{static\_cast<}IntermediateRep\textcolor{keyword}{>}(Factor::num);}
...
\DoxyCodeLine{00280\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{static\_cast<}IntermediateRep\textcolor{keyword}{>}(Factor::num);}
...
\DoxyCodeLine{00284\ \ \ \ \ \}}
\DoxyCodeLine{00285\ \ \ \ \ count\ *=\ \textcolor{keyword}{static\_cast<}IntermediateRep\textcolor{keyword}{>}(Factor::num);}
\DoxyCodeLine{00286\ \ \ \}}
\DoxyCodeLine{00287\ }
...
\DoxyCodeLine{00291\ \ \ \ \ count\ /=\ \textcolor{keyword}{static\_cast<}common\_t\textcolor{keyword}{>}(Factor::den);}
\DoxyCodeLine{00292\ \ \ \}}
\DoxyCodeLine{00293\ }
...
\DoxyCodeLine{00308\ \textcolor{preprocessor}{\#define\ FMT\_NOMACRO}}
\DoxyCodeLine{00309\ }
\DoxyCodeLine{00310\ \textcolor{keyword}{namespace\ }detail\ \{}
\DoxyCodeLine{00311\ \textcolor{keyword}{inline}\ null<>\ localtime\_r\ FMT\_NOMACRO(...)\ \{\ \textcolor{keywordflow}{return}\ null<>();\ \}}
...
\DoxyCodeLine{00324\ }
\DoxyCodeLine{00325\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacetask__chaining__test_add9a02f75b3912432ea6b1ffd083c3b3}{run}}()\ \{}
\DoxyCodeLine{00326\ \ \ \ \ \ \ \textcolor{keyword}{using\ namespace\ }fmt::detail;}
\DoxyCodeLine{00327\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ handle(localtime\_r(\&time\_,\ \&tm\_));}
\DoxyCodeLine{00328\ \ \ \ \ \}}
\DoxyCodeLine{00329\ }
\DoxyCodeLine{00330\ \ \ \ \ \textcolor{keywordtype}{bool}\ handle(std::tm*\ tm)\ \{\ \textcolor{keywordflow}{return}\ tm\ !=\ \textcolor{keyword}{nullptr};\ \}}
\DoxyCodeLine{00331\ }
\DoxyCodeLine{00332\ \ \ \ \ \textcolor{keywordtype}{bool}\ handle(\mbox{\hyperlink{structdetail_1_1null}{detail::null<>}})\ \{}
\DoxyCodeLine{00333\ \ \ \ \ \ \ \textcolor{keyword}{using\ namespace\ }fmt::detail;}
...
\DoxyCodeLine{00338\ }
\DoxyCodeLine{00339\ \textcolor{preprocessor}{\#if\ !FMT\_MSC\_VER}}
\DoxyCodeLine{00340\ \ \ \ \ \textcolor{keywordtype}{bool}\ fallback(\mbox{\hyperlink{structdetail_1_1null}{detail::null<>}})\ \{}
\DoxyCodeLine{00341\ \ \ \ \ \ \ \textcolor{keyword}{using\ namespace\ }fmt::detail;}
...
\DoxyCodeLine{00344\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ tm\ !=\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00345\ \ \ \ \ \}}
...
\DoxyCodeLine{00350\ \ \ \textcolor{keywordflow}{if}\ (!lt.run())\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}time\_t\ value\ out\ of\ range"{}}));}
...
\DoxyCodeLine{00361\ }
\DoxyCodeLine{00362\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacetask__chaining__test_add9a02f75b3912432ea6b1ffd083c3b3}{run}}()\ \{}
\DoxyCodeLine{00363\ \ \ \ \ \ \ \textcolor{keyword}{using\ namespace\ }fmt::detail;}
\DoxyCodeLine{00364\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ handle(gmtime\_r(\&time\_,\ \&tm\_));}
\DoxyCodeLine{00365\ \ \ \ \ \}}
\DoxyCodeLine{00366\ }
\DoxyCodeLine{00367\ \ \ \ \ \textcolor{keywordtype}{bool}\ handle(std::tm*\ tm)\ \{\ \textcolor{keywordflow}{return}\ tm\ !=\ \textcolor{keyword}{nullptr};\ \}}
\DoxyCodeLine{00368\ }
\DoxyCodeLine{00369\ \ \ \ \ \textcolor{keywordtype}{bool}\ handle(\mbox{\hyperlink{structdetail_1_1null}{detail::null<>}})\ \{}
\DoxyCodeLine{00370\ \ \ \ \ \ \ \textcolor{keyword}{using\ namespace\ }fmt::detail;}
...
\DoxyCodeLine{00375\ }
\DoxyCodeLine{00376\ \textcolor{preprocessor}{\#if\ !FMT\_MSC\_VER}}
\DoxyCodeLine{00377\ \ \ \ \ \textcolor{keywordtype}{bool}\ fallback(\mbox{\hyperlink{structdetail_1_1null}{detail::null<>}})\ \{}
...
\DoxyCodeLine{00380\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ tm\ !=\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00381\ \ \ \ \ \}}
...
\DoxyCodeLine{00386\ \ \ \textcolor{keywordflow}{if}\ (!gt.run())\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}time\_t\ value\ out\ of\ range"{}}));}
\DoxyCodeLine{00387\ \ \ \textcolor{keywordflow}{return}\ gt.tm\_;}
\DoxyCodeLine{00388\ \}}
\DoxyCodeLine{00389\ }
\DoxyCodeLine{00390\ \textcolor{keyword}{namespace\ }detail\ \{}
\DoxyCodeLine{00391\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{size\_t}\ strftime(\textcolor{keywordtype}{char}*\ str,\ \textcolor{keywordtype}{size\_t}\ count,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ format,}
...
\DoxyCodeLine{00394\ \}}
\DoxyCodeLine{00395\ }
\DoxyCodeLine{00396\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{size\_t}\ strftime(\textcolor{keywordtype}{wchar\_t}*\ str,\ \textcolor{keywordtype}{size\_t}\ count,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{wchar\_t}*\ format,}
...
\DoxyCodeLine{00401\ }
\DoxyCodeLine{00402\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structformatter}{formatter}}<std::tm,\ Char>\ \{}
...
\DoxyCodeLine{00437\ \ \ \}}
\DoxyCodeLine{00438\ }
\DoxyCodeLine{00439\ \ \ \mbox{\hyperlink{classbasic__memory__buffer}{basic\_memory\_buffer<Char>}}\ tm\_format;}
\DoxyCodeLine{00440\ \};}
\DoxyCodeLine{00441\ }
\DoxyCodeLine{00442\ \textcolor{keyword}{namespace\ }detail\ \{}
\DoxyCodeLine{00443\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Period>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units()\ \{}
\DoxyCodeLine{00444\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00445\ \}}
\DoxyCodeLine{00446\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::atto>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}as"{}};\ \}}
\DoxyCodeLine{00447\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::femto>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}fs"{}};\ \}}
\DoxyCodeLine{00448\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::pico>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}ps"{}};\ \}}
\DoxyCodeLine{00449\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::nano>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}ns"{}};\ \}}
\DoxyCodeLine{00450\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::micro>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}µs"{}};\ \}}
\DoxyCodeLine{00451\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::milli>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}ms"{}};\ \}}
\DoxyCodeLine{00452\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::centi>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}cs"{}};\ \}}
\DoxyCodeLine{00453\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::deci>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}ds"{}};\ \}}
\DoxyCodeLine{00454\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::ratio<1>>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}s"{}};\ \}}
\DoxyCodeLine{00455\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::deca>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}das"{}};\ \}}
\DoxyCodeLine{00456\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::hecto>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}hs"{}};\ \}}
\DoxyCodeLine{00457\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::kilo>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}ks"{}};\ \}}
\DoxyCodeLine{00458\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::mega>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}Ms"{}};\ \}}
\DoxyCodeLine{00459\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::giga>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}Gs"{}};\ \}}
\DoxyCodeLine{00460\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::tera>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}Ts"{}};\ \}}
\DoxyCodeLine{00461\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::peta>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}Ps"{}};\ \}}
\DoxyCodeLine{00462\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::exa>()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}Es"{}};\ \}}
\DoxyCodeLine{00463\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::ratio<60>>()\ \{}
\DoxyCodeLine{00464\ \ \ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}m"{}};}
\DoxyCodeLine{00465\ \}}
\DoxyCodeLine{00466\ \textcolor{keyword}{template}\ <>\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ get\_units<std::ratio<3600>>()\ \{}
\DoxyCodeLine{00467\ \ \ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}h"{}};}
\DoxyCodeLine{00468\ \}}
\DoxyCodeLine{00469\ }
\DoxyCodeLine{00470\ \textcolor{keyword}{enum\ class}\ numeric\_system\ \{}
...
\DoxyCodeLine{00478\ FMT\_CONSTEXPR\ \textcolor{keyword}{const}\ Char*\ parse\_chrono\_format(\textcolor{keyword}{const}\ Char*\ begin,}
...
\DoxyCodeLine{00484\ \ \ \ \ \textcolor{keywordflow}{if}\ (c\ ==\ \textcolor{charliteral}{'\}'})\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00485\ \ \ \ \ \textcolor{keywordflow}{if}\ (c\ !=\ \textcolor{charliteral}{'\%'})\ \{}
...
\DoxyCodeLine{00491\ \ \ \ \ \textcolor{keywordflow}{if}\ (ptr\ ==\ end)\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid\ format"{}}));}
\DoxyCodeLine{00492\ \ \ \ \ c\ =\ *ptr++;}
\DoxyCodeLine{00493\ \ \ \ \ \textcolor{keywordflow}{switch}\ (c)\ \{}
\DoxyCodeLine{00494\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'\%'}:}
\DoxyCodeLine{00495\ \ \ \ \ \ \ handler.on\_text(ptr\ -\/\ 1,\ ptr);}
\DoxyCodeLine{00496\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00497\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'n'}:\ \{}
\DoxyCodeLine{00498\ \ \ \ \ \ \ \textcolor{keyword}{const}\ Char\ newline[]\ =\ \{\textcolor{charliteral}{'\(\backslash\)n'}\};}
\DoxyCodeLine{00499\ \ \ \ \ \ \ handler.on\_text(newline,\ newline\ +\ 1);}
\DoxyCodeLine{00500\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00501\ \ \ \ \ \}}
\DoxyCodeLine{00502\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'t'}:\ \{}
\DoxyCodeLine{00503\ \ \ \ \ \ \ \textcolor{keyword}{const}\ Char\ tab[]\ =\ \{\textcolor{charliteral}{'\(\backslash\)t'}\};}
...
\DoxyCodeLine{00511\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'A'}:}
\DoxyCodeLine{00512\ \ \ \ \ \ \ handler.on\_full\_weekday();}
\DoxyCodeLine{00513\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00514\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'w'}:}
...
\DoxyCodeLine{00521\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'b'}:}
\DoxyCodeLine{00522\ \ \ \ \ \ \ handler.on\_abbr\_month();}
\DoxyCodeLine{00523\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00524\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'B'}:}
...
\DoxyCodeLine{00528\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'H'}:}
\DoxyCodeLine{00529\ \ \ \ \ \ \ handler.on\_24\_hour(numeric\_system::standard);}
\DoxyCodeLine{00530\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00531\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'I'}:}
...
\DoxyCodeLine{00537\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'S'}:}
...
\DoxyCodeLine{00581\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'E'}:\ \{}
\DoxyCodeLine{00582\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (ptr\ ==\ end)\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid\ format"{}}));}
...
\DoxyCodeLine{00588\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'x'}:}
\DoxyCodeLine{00589\ \ \ \ \ \ \ \ \ handler.on\_loc\_date(numeric\_system::alternative);}
\DoxyCodeLine{00590\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00591\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'X'}:}
...
\DoxyCodeLine{00595\ \ \ \ \ \ \ \ \ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid\ format"{}}));}
\DoxyCodeLine{00596\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00597\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00598\ \ \ \ \ \}}
\DoxyCodeLine{00599\ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'O'}:}
\DoxyCodeLine{00600\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (ptr\ ==\ end)\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid\ format"{}}));}
\DoxyCodeLine{00601\ \ \ \ \ \ \ c\ =\ *ptr++;}
\DoxyCodeLine{00602\ \ \ \ \ \ \ \textcolor{keywordflow}{switch}\ (c)\ \{}
\DoxyCodeLine{00603\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'w'}:}
\DoxyCodeLine{00604\ \ \ \ \ \ \ \ \ handler.on\_dec0\_weekday(numeric\_system::alternative);}
\DoxyCodeLine{00605\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00606\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'u'}:}
\DoxyCodeLine{00607\ \ \ \ \ \ \ \ \ handler.on\_dec1\_weekday(numeric\_system::alternative);}
\DoxyCodeLine{00608\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00609\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'H'}:}
\DoxyCodeLine{00610\ \ \ \ \ \ \ \ \ handler.on\_24\_hour(numeric\_system::alternative);}
\DoxyCodeLine{00611\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00612\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'I'}:}
\DoxyCodeLine{00613\ \ \ \ \ \ \ \ \ handler.on\_12\_hour(numeric\_system::alternative);}
\DoxyCodeLine{00614\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00615\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'M'}:}
\DoxyCodeLine{00616\ \ \ \ \ \ \ \ \ handler.on\_minute(numeric\_system::alternative);}
\DoxyCodeLine{00617\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00618\ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \textcolor{charliteral}{'S'}:}
...
\DoxyCodeLine{00622\ \ \ \ \ \ \ \ \ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid\ format"{}}));}
\DoxyCodeLine{00623\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00624\ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00625\ \ \ \ \ \textcolor{keywordflow}{default}:}
\DoxyCodeLine{00626\ \ \ \ \ \ \ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid\ format"{}}));}
\DoxyCodeLine{00627\ \ \ \ \ \}}
...
\DoxyCodeLine{00635\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ report\_no\_date()\ \{\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}no\ date"{}}));\ \}}
\DoxyCodeLine{00636\ }
...
\DoxyCodeLine{00638\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_abbr\_weekday()\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00639\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_full\_weekday()\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00640\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_dec0\_weekday(numeric\_system)\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00641\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_dec1\_weekday(numeric\_system)\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00642\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_abbr\_month()\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00643\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_full\_month()\ \{\ report\_no\_date();\ \}}
...
\DoxyCodeLine{00648\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_datetime(numeric\_system)\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00649\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_loc\_date(numeric\_system)\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00650\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_loc\_time(numeric\_system)\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00651\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_us\_date()\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00652\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_iso\_date()\ \{\ report\_no\_date();\ \}}
...
\DoxyCodeLine{00659\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_utc\_offset()\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00660\ \ \ FMT\_NORETURN\ \textcolor{keywordtype}{void}\ on\_tz\_name()\ \{\ report\_no\_date();\ \}}
\DoxyCodeLine{00661\ \};}
\DoxyCodeLine{00662\ }
\DoxyCodeLine{00663\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{int}egral<T>::value)>}
...
\DoxyCodeLine{00666\ \}}
\DoxyCodeLine{00667\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{float}ing\_po\textcolor{keywordtype}{int}<T>::value)>}
...
\DoxyCodeLine{00670\ \}}
\DoxyCodeLine{00671\ }
\DoxyCodeLine{00672\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{int}egral<T>::value)>}
...
\DoxyCodeLine{00675\ \}}
\DoxyCodeLine{00676\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{float}ing\_po\textcolor{keywordtype}{int}<T>::value)>}
...
\DoxyCodeLine{00682\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{int}egral<T>::value)>}
...
\DoxyCodeLine{00684\ \ \ FMT\_ASSERT(value\ >=\ 0\ \&\&\ value\ <=\ upper,\ \textcolor{stringliteral}{"{}invalid\ value"{}});}
\DoxyCodeLine{00685\ \ \ (void)upper;}
\DoxyCodeLine{00686\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(value);}
\DoxyCodeLine{00687\ \}}
\DoxyCodeLine{00688\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(!std::is\_\textcolor{keywordtype}{int}egral<T>::value)>}
...
\DoxyCodeLine{00690\ \ \ FMT\_ASSERT(}
\DoxyCodeLine{00691\ \ \ \ \ \ \ std::isnan(value)\ ||\ (value\ >=\ 0\ \&\&\ value\ <=\ \textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(upper)),}
\DoxyCodeLine{00692\ \ \ \ \ \ \ \textcolor{stringliteral}{"{}invalid\ value"{}});}
\DoxyCodeLine{00693\ \ \ (void)upper;}
\DoxyCodeLine{00694\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(value);}
\DoxyCodeLine{00695\ \}}
\DoxyCodeLine{00696\ }
\DoxyCodeLine{00697\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{int}egral<T>::value)>}
\DoxyCodeLine{00698\ \textcolor{keyword}{inline}\ T\ mod(T\ x,\ \textcolor{keywordtype}{int}\ y)\ \{}
\DoxyCodeLine{00699\ \ \ \textcolor{keywordflow}{return}\ x\ \%\ \textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(y);}
\DoxyCodeLine{00700\ \}}
\DoxyCodeLine{00701\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ FMT\_ENABLE\_IF(std::is\_\textcolor{keywordtype}{float}ing\_po\textcolor{keywordtype}{int}<T>::value)>}
\DoxyCodeLine{00702\ \textcolor{keyword}{inline}\ T\ mod(T\ x,\ \textcolor{keywordtype}{int}\ y)\ \{}
\DoxyCodeLine{00703\ \ \ \textcolor{keywordflow}{return}\ std::fmod(x,\ \textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(y));}
\DoxyCodeLine{00704\ \}}
\DoxyCodeLine{00705\ }
...
\DoxyCodeLine{00708\ template\ <typename\ T,\ bool\ INTEGRAL\ =\ std::is\_integral<T>::value>}
...
\DoxyCodeLine{00711\ \};}
\DoxyCodeLine{00712\ }
\DoxyCodeLine{00713\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdetail_1_1make__unsigned__or__unchanged}{make\_unsigned\_or\_unchanged}}<T,\ true>\ \{}
\DoxyCodeLine{00714\ \ \ \textcolor{keyword}{using\ }type\ =\ \textcolor{keyword}{typename}\ std::make\_unsigned<T>::type;}
\DoxyCodeLine{00715\ \};}
\DoxyCodeLine{00716\ }
\DoxyCodeLine{00717\ \textcolor{preprocessor}{\#if\ FMT\_SAFE\_DURATION\_CAST}}
...
\DoxyCodeLine{00723\ \ \ \textcolor{keywordflow}{if}\ (ec)\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}cannot\ format\ duration"{}}));}
...
\DoxyCodeLine{00729\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_integral<Rep>::value)>}
...
\DoxyCodeLine{00734\ \textcolor{preprocessor}{\#if\ FMT\_SAFE\_DURATION\_CAST}}
...
\DoxyCodeLine{00752\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(std::is\_floating\_point<Rep>::value)>}
...
\DoxyCodeLine{00756\ \ \ \textcolor{keyword}{auto}\ ms\ =\ mod(d.count()\ *\ \textcolor{keyword}{static\_cast<}common\_type\textcolor{keyword}{>}(Period::num)\ /}
\DoxyCodeLine{00757\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{static\_cast<}common\_type\textcolor{keyword}{>}(Period::den)\ *\ 1000,}
\DoxyCodeLine{00758\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ 1000);}
\DoxyCodeLine{00759\ \ \ \textcolor{keywordflow}{return}\ std::chrono::duration<Rep,\ std::milli>(\textcolor{keyword}{static\_cast<}Rep\textcolor{keyword}{>}(ms));}
\DoxyCodeLine{00760\ \}}
\DoxyCodeLine{00761\ }
...
\DoxyCodeLine{00764\ \ \ \textcolor{keyword}{const}\ Char\ pr\_f[]\ =\ \{\textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{':'},\ \textcolor{charliteral}{'.'},\ \textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{'\}'},\ \textcolor{charliteral}{'f'},\ \textcolor{charliteral}{'\}'},\ 0\};}
\DoxyCodeLine{00765\ \ \ \textcolor{keywordflow}{if}\ (precision\ >=\ 0)\ \textcolor{keywordflow}{return}\ format\_to(out,\ pr\_f,\ val,\ precision);}
\DoxyCodeLine{00766\ \ \ \textcolor{keyword}{const}\ Char\ fp\_f[]\ =\ \{\textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{':'},\ \textcolor{charliteral}{'g'},\ \textcolor{charliteral}{'\}'},\ 0\};}
\DoxyCodeLine{00767\ \ \ \textcolor{keyword}{const}\ Char\ format[]\ =\ \{\textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{'\}'},\ 0\};}
...
\DoxyCodeLine{00772\ OutputIt\ copy\_unit(\mbox{\hyperlink{classbasic__string__view}{string\_view}}\ unit,\ OutputIt\ out,\ Char)\ \{}
...
\DoxyCodeLine{00777\ OutputIt\ copy\_unit(\mbox{\hyperlink{classbasic__string__view}{string\_view}}\ unit,\ OutputIt\ out,\ \textcolor{keywordtype}{wchar\_t})\ \{}
...
\DoxyCodeLine{00780\ \ \ utf8\_to\_utf16\ u(unit);}
...
\DoxyCodeLine{00787\ \ \ \ \ \textcolor{keywordflow}{return}\ copy\_unit(\mbox{\hyperlink{classbasic__string__view}{string\_view}}(unit),\ out,\ Char());}
\DoxyCodeLine{00788\ \ \ \textcolor{keyword}{const}\ Char\ num\_f[]\ =\ \{\textcolor{charliteral}{'['},\ \textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{'\}'},\ \textcolor{charliteral}{']'},\ \textcolor{charliteral}{'s'},\ 0\};}
...
\DoxyCodeLine{00790\ \ \ \textcolor{keyword}{const}\ Char\ num\_def\_f[]\ =\ \{\textcolor{charliteral}{'['},\ \textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{'\}'},\ \textcolor{charliteral}{'/'},\ \textcolor{charliteral}{'\{'},\ \textcolor{charliteral}{'\}'},\ \textcolor{charliteral}{']'},\ \textcolor{charliteral}{'s'},\ 0\};}
...
\DoxyCodeLine{00801\ \ \ \textcolor{keyword}{using\ }rep\ =}
\DoxyCodeLine{00802\ \ \ \ \ \ \ conditional\_t<std::is\_integral<Rep>::value\ \&\&\ \textcolor{keyword}{sizeof}(Rep)\ <\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{int}),}
\DoxyCodeLine{00803\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ unsigned,\ \textcolor{keyword}{typename}\ make\_unsigned\_or\_unchanged<Rep>::type>;}
\DoxyCodeLine{00804\ \ \ rep\ val;}
\DoxyCodeLine{00805\ \ \ \textcolor{keyword}{using\ }seconds\ =\ std::chrono::duration<rep>;}
\DoxyCodeLine{00806\ \ \ seconds\ s;}
\DoxyCodeLine{00807\ \ \ \textcolor{keyword}{using\ }milliseconds\ =\ std::chrono::duration<rep,\ std::milli>;}
...
\DoxyCodeLine{00811\ }
\DoxyCodeLine{00812\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structdetail_1_1chrono__formatter}{chrono\_formatter}}(FormatContext\&\ ctx,\ OutputIt\ o,}
...
\DoxyCodeLine{00851\ \ \ \}}
\DoxyCodeLine{00852\ }
\DoxyCodeLine{00853\ \ \ Rep\ hour()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}Rep\textcolor{keyword}{>}(mod((s.count()\ /\ 3600),\ 24));\ \}}
\DoxyCodeLine{00854\ }
...
\DoxyCodeLine{00858\ \ \ \}}
\DoxyCodeLine{00859\ }
\DoxyCodeLine{00860\ \ \ Rep\ minute()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}Rep\textcolor{keyword}{>}(mod((s.count()\ /\ 60),\ 60));\ \}}
\DoxyCodeLine{00861\ \ \ Rep\ second()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}Rep\textcolor{keyword}{>}(mod(s.count(),\ 60));\ \}}
\DoxyCodeLine{00862\ }
...
\DoxyCodeLine{00876\ \ \ \}}
\DoxyCodeLine{00877\ }
\DoxyCodeLine{00878\ \ \ \textcolor{keywordtype}{void}\ write(Rep\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keywordtype}{int}\ width)\ \{}
\DoxyCodeLine{00879\ \ \ \ \ write\_sign();}
\DoxyCodeLine{00880\ \ \ \ \ \textcolor{keywordflow}{if}\ (isnan(\mbox{\hyperlink{classdetail_1_1value}{value}}))\ \textcolor{keywordflow}{return}\ write\_nan();}
\DoxyCodeLine{00881\ \ \ \ \ uint32\_or\_64\_or\_128\_t<int>\ n\ =}
\DoxyCodeLine{00882\ \ \ \ \ \ \ \ \ to\_unsigned(to\_nonnegative\_int(\mbox{\hyperlink{classdetail_1_1value}{value}},\ max\_value<int>()));}
...
\DoxyCodeLine{01016\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structformatter}{formatter}}<std::chrono::duration<Rep,\ Period>,\ Char>\ \{}
\DoxyCodeLine{01017\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{01018\ \ \ \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs<Char>}}\ specs;}
\DoxyCodeLine{01019\ \ \ \textcolor{keywordtype}{int}\ precision;}
\DoxyCodeLine{01020\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}\ =\ \mbox{\hyperlink{structdetail_1_1arg__ref}{detail::arg\_ref<Char>}};}
\DoxyCodeLine{01021\ \ \ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}\ width\_ref;}
\DoxyCodeLine{01022\ \ \ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}\ precision\_ref;}
\DoxyCodeLine{01023\ \ \ \textcolor{keyword}{mutable}\ \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}}\ format\_str;}
...
\DoxyCodeLine{01027\ \ \ \ \ \mbox{\hyperlink{structformatter}{formatter}}\&\ f;}
\DoxyCodeLine{01028\ \ \ \ \ \mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char>}}\&\ context;}
\DoxyCodeLine{01029\ \ \ \ \ \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}}\ format\_str;}
\DoxyCodeLine{01030\ }
\DoxyCodeLine{01031\ \ \ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Id>\ FMT\_CONSTEXPR\ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}\ make\_arg\_ref(Id\ arg\_id)\ \{}
\DoxyCodeLine{01032\ \ \ \ \ \ \ context.\mbox{\hyperlink{classbasic__format__parse__context_a7a548535000cbd315a9ac35996950eec}{check\_arg\_id}}(arg\_id);}
\DoxyCodeLine{01033\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}(arg\_id);}
\DoxyCodeLine{01034\ \ \ \ \ \}}
\DoxyCodeLine{01035\ }
\DoxyCodeLine{01036\ \ \ \ \ FMT\_CONSTEXPR\ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}\ make\_arg\_ref(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}}\ arg\_id)\ \{}
\DoxyCodeLine{01037\ \ \ \ \ \ \ context.\mbox{\hyperlink{classbasic__format__parse__context_a7a548535000cbd315a9ac35996950eec}{check\_arg\_id}}(arg\_id);}
\DoxyCodeLine{01038\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}(arg\_id);}
\DoxyCodeLine{01039\ \ \ \ \ \}}
\DoxyCodeLine{01040\ }
\DoxyCodeLine{01041\ \ \ \ \ FMT\_CONSTEXPR\ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}\ make\_arg\_ref(\mbox{\hyperlink{structdetail_1_1auto__id}{detail::auto\_id}})\ \{}
\DoxyCodeLine{01042\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{structdetail_1_1arg__ref}{arg\_ref\_type}}(context.\mbox{\hyperlink{classbasic__format__parse__context_a75c83556b48d6b5ee7b4866296888727}{next\_arg\_id}}());}
\DoxyCodeLine{01043\ \ \ \ \ \}}
\DoxyCodeLine{01044\ }
\DoxyCodeLine{01045\ \ \ \ \ \textcolor{keywordtype}{void}\ on\_error(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ msg)\ \{\ FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(msg));\ \}}
\DoxyCodeLine{01046\ \ \ \ \ \textcolor{keywordtype}{void}\ on\_fill(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}}\ fill)\ \{\ f.specs.fill\ =\ fill;\ \}}
...
\DoxyCodeLine{01065\ \ \ \};}
\DoxyCodeLine{01066\ }
\DoxyCodeLine{01067\ \ \ FMT\_CONSTEXPR\ parse\_range\ do\_parse(\mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char>}}\&\ ctx)\ \{}
\DoxyCodeLine{01068\ \ \ \ \ \textcolor{keyword}{auto}\ begin\ =\ ctx.\mbox{\hyperlink{classbasic__format__parse__context_a3aedbd66520975bb680d427778f636a5}{begin}}(),\ end\ =\ ctx.\mbox{\hyperlink{classbasic__format__parse__context_a9d4a735fcc467d31d25a3ca537461d1d}{end}}();}
\DoxyCodeLine{01069\ \ \ \ \ \textcolor{keywordflow}{if}\ (begin\ ==\ end\ ||\ *begin\ ==\ \textcolor{charliteral}{'\}'})\ \textcolor{keywordflow}{return}\ \{begin,\ begin\};}
...
\DoxyCodeLine{01075\ \ \ \ \ \textcolor{keywordflow}{if}\ (*begin\ ==\ \textcolor{charliteral}{'.'})\ \{}
...
\DoxyCodeLine{01080\ \ \ \ \ \}}
\DoxyCodeLine{01081\ \ \ \ \ end\ =\ parse\_chrono\_format(begin,\ end,\ \mbox{\hyperlink{structdetail_1_1chrono__format__checker}{detail::chrono\_format\_checker}}());}
\DoxyCodeLine{01082\ \ \ \ \ \textcolor{keywordflow}{return}\ \{begin,\ end\};}
\DoxyCodeLine{01083\ \ \ \}}
\DoxyCodeLine{01084\ }
\DoxyCodeLine{01085\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01086\ \ \ \mbox{\hyperlink{structformatter}{formatter}}()\ :\ precision(-\/1)\ \{\}}
\DoxyCodeLine{01087\ }
\DoxyCodeLine{01088\ \ \ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ parse(\mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char>}}\&\ ctx)}
\DoxyCodeLine{01089\ \ \ \ \ \ \ -\/>\ \textcolor{keyword}{decltype}(ctx.\mbox{\hyperlink{classbasic__format__parse__context_a3aedbd66520975bb680d427778f636a5}{begin}}())\ \{}
...
\DoxyCodeLine{01119\ \};}
\DoxyCodeLine{01120\ }
\DoxyCodeLine{01121\ FMT\_END\_NAMESPACE}
\DoxyCodeLine{01122\ }
\DoxyCodeLine{01123\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ FMT\_CHRONO\_H\_}}
