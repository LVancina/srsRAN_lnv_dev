...
\hypertarget{signal__handler_8h_source}{}\label{signal__handler_8h_source}\index{include/srsran/support/signal\_handler.h@{include/srsran/support/signal\_handler.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{comment}{//\ \(\backslash\)brief\ Common\ signal\ handling\ methods\ for\ applications.}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#}\textcolor{preprocessor}{pragma}\ \textcolor{preprocessor}{once}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{using}\ srsran\_signal\_handler\ =\ \textcolor{keywordtype}{void}\ (*)();}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{comment}{///\ Registers\ the\ specified\ function\ to\ be\ called\ when\ the\ user\ interrupts\ the\ program\ execution\ (eg:\ via\ Ctrl+C).}}
\DoxyCodeLine{00030\ \textcolor{comment}{///\ Passing\ a\ null\ function\ pointer\ disables\ the\ current\ installed\ handler.}}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{void}\ register\_signal\_handler(srsran\_signal\_handler\ handler);}
