...
\DoxyCodeLine{00037\ simd256\_type\ \mbox{\hyperlink{classsrsran_1_1detail_1_1simd__span_add809f5993e21734d5cc53a85d8bbb46}{simd\_span<simdWrapper,\ storageType>::get\_at}}(help\_type<simd256\_wrapper>\ ,\ \textcolor{keywordtype}{unsigned}\ pos)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00040\ \ \ \textcolor{keywordflow}{return}\ \_mm256\_loadu\_si256(\textcolor{keyword}{reinterpret\_cast<}\textcolor{keyword}{const\ }\_\_m256i*\textcolor{keyword}{>}(array\_ptr)\ +\ pos);}
\DoxyCodeLine{00041\ \}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ simdWrapper,\ \textcolor{keyword}{typename}\ storageType>}
\DoxyCodeLine{00044\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classsrsran_1_1detail_1_1simd__span_a552e621763fe226ef28a535fd94362c7}{simd\_span<simdWrapper,\ storageType>::set\_at}}(\textcolor{keywordtype}{unsigned}\ pos,\ simd256\_type\ val)}
\DoxyCodeLine{00045\ \{}
...
\DoxyCodeLine{00048\ \ \ \_mm256\_storeu\_si256(\textcolor{keyword}{reinterpret\_cast<}\_\_m256i*\textcolor{keyword}{>}(array\_ptr)\ +\ pos,\ val);}
\DoxyCodeLine{00049\ \}}
\DoxyCodeLine{00050\ }
...
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \textcolor{keyword}{using\ }avx2\_span\ \ \ \ \ \ \ =\ \mbox{\hyperlink{classsrsran_1_1detail_1_1simd__span}{detail::simd\_span<detail::simd256\_wrapper,\ int8\_t>}};}
\DoxyCodeLine{00056\ \textcolor{keyword}{using\ }avx2\_const\_span\ =\ \mbox{\hyperlink{classsrsran_1_1detail_1_1simd__span}{detail::simd\_span<detail::simd256\_wrapper,\ const\ int8\_t>}};}
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00065\ \textcolor{keyword}{inline}\ \_\_m256i\ \mbox{\hyperlink{avx2__support_8h_a248288efc817de94b1ca5db6a88de735}{scale\_epi8}}(\_\_m256i\ a,\ \textcolor{keywordtype}{float}\ sf,\ uint8\_t\ max)}
\DoxyCodeLine{00066\ \{}
...
\DoxyCodeLine{00077\ \ \ \textcolor{keyword}{const}\ \_\_m256i\ \ \ \ \ \ \ \ \ \ \ \ \ MAX\_epi8\ \ =\ \_mm256\_set1\_epi8(\mbox{\hyperlink{namespacesrsran_a2918c0347dde854fce1aaebb70a16c33}{max}});}
\DoxyCodeLine{00078\ \ \ \textcolor{keyword}{const}\ \_\_m256i\ \ \ \ \ \ \ \ \ \ \ \ \ MIN\_epi8\ \ =\ \_mm256\_set1\_epi8(-\/\mbox{\hyperlink{namespacesrsran_a2918c0347dde854fce1aaebb70a16c33}{max}});}
\DoxyCodeLine{00079\ }
