\doxysection{meas\+\_\+types\+\_\+validators.\+h}
\hypertarget{meas__types__validators_8h_source}{}\label{meas__types__validators_8h_source}\index{include/srsran/rrc/meas\_types\_validators.h@{include/srsran/rrc/meas\_types\_validators.h}}
...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{comment}{///\ Validates\ the\ provided\ config(s).}}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{bool}\ validate\_config(\textcolor{keyword}{const}\ rrc\_meas\_trigger\_quant\_offset\&\ config);}
\DoxyCodeLine{00032\ \textcolor{keywordtype}{bool}\ validate\_config(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1srs__cu__cp_1_1rrc__cond__event__a3}{rrc\_cond\_event\_a3}}\&\ config);}
\DoxyCodeLine{00033\ }
