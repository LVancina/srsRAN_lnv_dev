...
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ "{}srsran/support/executors/task\_executor\_utils.h"{}}}
\DoxyCodeLine{00028\ }
...
\DoxyCodeLine{00036\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structsrsran_1_1detail_1_1strand__queue}{strand\_queue}}(\textcolor{keyword}{const}\ std::array<\textcolor{keywordtype}{unsigned},\ \textcolor{keyword}{sizeof}...(QueuePolicies)>\&\ strand\_queue\_sizes)\ :}
\DoxyCodeLine{00037\ \ \ \ \ queue(strand\_queue\_sizes,\ std::chrono::microseconds\{0\})}
\DoxyCodeLine{00038\ \ \ \{}
\DoxyCodeLine{00039\ \ \ \}}
\DoxyCodeLine{00040\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structsrsran_1_1detail_1_1strand__queue}{strand\_queue}}(\mbox{\hyperlink{classsrsran_1_1span}{span<const\ unsigned>}}\ strand\_queue\_sizes)\ :}
\DoxyCodeLine{00041\ \ \ \ \ queue(}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ [\&strand\_queue\_sizes]()\ \{}
\DoxyCodeLine{00043\ \ \ \ \ \ \ \ \ \ \ report\_error\_if\_not(strand\_queue\_sizes.\mbox{\hyperlink{classsrsran_1_1span_ad0e376d95ca916144eac76f27f0654ac}{size}}()\ ==\ \textcolor{keyword}{sizeof}...(QueuePolicies),}
\DoxyCodeLine{00044\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}Number\ of\ queue\ sizes\ must\ match\ number\ of\ policies"{}});}
\DoxyCodeLine{00045\ \ \ \ \ \ \ \ \ \ \ std::array<unsigned,\ \textcolor{keyword}{sizeof}...(QueuePolicies)>\ sizes;}
...
\DoxyCodeLine{00053\ \ \ \}}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00056\ \ \ \textcolor{keywordtype}{bool}\ try\_push(\mbox{\hyperlink{classsrsran_1_1unique__function}{unique\_task}}\ task)}
\DoxyCodeLine{00057\ \ \ \{}
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{keywordflow}{return}\ queue.template\ try\_push<Priority>(std::move(task));}
\DoxyCodeLine{00059\ \ \ \}}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00062\ \ \ \textcolor{keyword}{auto}\ get\_enqueuer()}
\DoxyCodeLine{00063\ \ \ \{}
\DoxyCodeLine{00064\ \ \ \ \ \textcolor{keywordflow}{return}\ queue.template\ get\_non\_blocking\_enqueuer<Priority>();}
\DoxyCodeLine{00065\ \ \ \}}
\DoxyCodeLine{00066\ }
\DoxyCodeLine{00067\ \ \ \mbox{\hyperlink{classsrsran_1_1concurrent__priority__queue}{concurrent\_priority\_queue}}<\mbox{\hyperlink{namespacesrsran_ae4f0a84d474968b3437093240d943c33}{unique\_task}},\ QueuePolicies...>\ queue;}
\DoxyCodeLine{00068\ \};}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00070\ \textcolor{comment}{//\ Specialization\ for\ strand\ with\ single\ queue.}}
\DoxyCodeLine{00071\ \textcolor{keyword}{template}\ <concurrent\_queue\_policy\ QueuePolicy>}
...
\DoxyCodeLine{00073\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structsrsran_1_1detail_1_1strand__queue}{strand\_queue}}(\textcolor{keywordtype}{unsigned}\ strand\_queue\_size)\ :\ queue(strand\_queue\_size)\ \{\}}
\DoxyCodeLine{00074\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structsrsran_1_1detail_1_1strand__queue}{strand\_queue}}(\mbox{\hyperlink{classsrsran_1_1span}{span<const\ unsigned>}}\ strand\_queue\_sizes)\ :}
\DoxyCodeLine{00075\ \ \ \ \ queue([\&strand\_queue\_sizes]()\ \{}
\DoxyCodeLine{00076\ \ \ \ \ \ \ report\_error\_if\_not(strand\_queue\_sizes.\mbox{\hyperlink{classsrsran_1_1span_ad0e376d95ca916144eac76f27f0654ac}{size}}()\ ==\ 1,\ \textcolor{stringliteral}{"{}Number\ of\ queue\ sizes\ must\ match\ number\ of\ policies"{}});}
\DoxyCodeLine{00077\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ strand\_queue\_sizes[0];}
\DoxyCodeLine{00078\ \ \ \ \ \}())}
\DoxyCodeLine{00079\ \ \ \{}
\DoxyCodeLine{00080\ \ \ \}}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00082\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00083\ \ \ \textcolor{keywordtype}{bool}\ try\_push(\mbox{\hyperlink{classsrsran_1_1unique__function}{unique\_task}}\ task)}
\DoxyCodeLine{00084\ \ \ \{}
\DoxyCodeLine{00085\ \ \ \ \ \textcolor{keywordflow}{return}\ queue.try\_push(std::move(task));}
\DoxyCodeLine{00086\ \ \ \}}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00088\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00089\ \ \ \textcolor{keyword}{auto}\ get\_enqueuer()}
\DoxyCodeLine{00090\ \ \ \{}
\DoxyCodeLine{00091\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classsrsran_1_1non__blocking__enqueuer}{non\_blocking\_enqueuer<unique\_task,\ QueuePolicy>}}\{queue\};}
\DoxyCodeLine{00092\ \ \ \}}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00094\ \ \ \mbox{\hyperlink{classsrsran_1_1concurrent__queue}{concurrent\_queue<unique\_task,\ QueuePolicy,\ concurrent\_queue\_wait\_policy::non\_blocking>}}\ queue;}
\DoxyCodeLine{00095\ \};}
\DoxyCodeLine{00096\ }
...
\DoxyCodeLine{00103\ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classsrsran_1_1base__task__strand}{\string~base\_task\_strand}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00104\ }
...
\DoxyCodeLine{00111\ \ \ \ \ \textcolor{keywordflow}{if}\ (not\ strand\_acquired)\ \{}
...
\DoxyCodeLine{00115\ \ \ \ \ \}}
\DoxyCodeLine{00116\ \ \ \ \ \textcolor{keywordflow}{return}\ this-\/>dispatch\_strand(is\_execute);}
\DoxyCodeLine{00117\ \ \ \}}
\DoxyCodeLine{00118\ }
...
\DoxyCodeLine{00127\ }
\DoxyCodeLine{00128\ \textcolor{keyword}{template}\ <concurrent\_queue\_policy\ QueuePolicy,\ \textcolor{keyword}{typename}\ StrandPtr>}
\DoxyCodeLine{00129\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl}{task\_strand\_executor\_impl}}\ final\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classsrsran_1_1task__executor}{task\_executor}}}
\DoxyCodeLine{00130\ \{}
\DoxyCodeLine{00131\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00132\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>}
\DoxyCodeLine{00133\ \ \ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl}{task\_strand\_executor\_impl}}(\mbox{\hyperlink{classsrsran_1_1non__blocking__enqueuer}{non\_blocking\_enqueuer<unique\_task,\ QueuePolicy>}}\ enqueuer\_,\ U\&\&\ strand\_)\ :}
\DoxyCodeLine{00134\ \ \ \ \ enqueuer(enqueuer\_),\ strand(std::forward<U>(strand\_))}
\DoxyCodeLine{00135\ \ \ \{}
\DoxyCodeLine{00136\ \ \ \}}
\DoxyCodeLine{00137\ }
\DoxyCodeLine{00138\ \ \ \mbox{\hyperlink{compiler_8h_a84270d7b45f0280051bd27685657e03e}{SRSRAN\_NODISCARD}}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl_afcd8914f8353ff5cc101199d65bd85ea}{execute}}(\mbox{\hyperlink{classsrsran_1_1unique__function}{unique\_task}}\ task)\textcolor{keyword}{\ override}}
\DoxyCodeLine{00139\ \textcolor{keyword}{\ \ }\{}
\DoxyCodeLine{00140\ \ \ \ \ \textcolor{comment}{//\ Enqueue\ task\ in\ task\_strand\ queue.}}
\DoxyCodeLine{00141\ \ \ \ \ \textcolor{keywordflow}{if}\ (not\ enqueuer.try\_push(std::move(task)))\ \{}
...
\DoxyCodeLine{00159\ \ \ \mbox{\hyperlink{classsrsran_1_1non__blocking__enqueuer}{non\_blocking\_enqueuer<unique\_task,\ QueuePolicy>}}\ enqueuer;}
...
\DoxyCodeLine{00169\ }
\DoxyCodeLine{00173\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00174\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl}{executor}}\ =}
\DoxyCodeLine{00175\ \ \ \ \ \ \ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl}{detail::task\_strand\_executor\_impl}}<\mbox{\hyperlink{namespacesrsran_a0b00ef08221ac8cbecd213e5864d72e2}{get\_priority\_queue\_policy}}<QueuePolicies...>(Priority),\ \mbox{\hyperlink{classsrsran_1_1base__task__strand}{base\_task\_strand}}*>;}
\DoxyCodeLine{00176\ }
\DoxyCodeLine{00177\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue}{task\_strand\_with\_queue}}(Args\&\&...\ queue\_params)\ :\ queue(std::forward<Args>(queue\_params)...)}
\DoxyCodeLine{00179\ \ \ \{}
\DoxyCodeLine{00180\ \ \ \}}
\DoxyCodeLine{00181\ }
\DoxyCodeLine{00183\ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue_a96180cf36355d1d2cb1b3b7a890eb032}{nof\_priority\_levels}}()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{sizeof}...(QueuePolicies);\ \}}
\DoxyCodeLine{00184\ }
\DoxyCodeLine{00185\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00186\ \ \ \mbox{\hyperlink{compiler_8h_a84270d7b45f0280051bd27685657e03e}{SRSRAN\_NODISCARD}}\ \textcolor{keywordtype}{bool}\ execute(\mbox{\hyperlink{classsrsran_1_1unique__function}{unique\_task}}\ task)}
\DoxyCodeLine{00187\ \ \ \{}
\DoxyCodeLine{00188\ \ \ \ \ \textcolor{comment}{//\ Enqueue\ task\ in\ task\_strand\ queue.}}
\DoxyCodeLine{00189\ \ \ \ \ \textcolor{keywordflow}{if}\ (not\ this-\/>queue.template\ try\_push<Priority>(std::move(task)))\ \{}
...
\DoxyCodeLine{00193\ \ \ \}}
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00195\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00196\ \ \ \mbox{\hyperlink{compiler_8h_a84270d7b45f0280051bd27685657e03e}{SRSRAN\_NODISCARD}}\ \textcolor{keywordtype}{bool}\ defer(\mbox{\hyperlink{namespacesrsran_ae4f0a84d474968b3437093240d943c33}{unique\_task}}\ task)}
\DoxyCodeLine{00197\ \ \ \{}
\DoxyCodeLine{00198\ \ \ \ \ \textcolor{comment}{//\ Enqueue\ task\ in\ task\_strand\ queue.}}
\DoxyCodeLine{00199\ \ \ \ \ \textcolor{keywordflow}{if}\ (not\ this-\/>queue.template\ try\_push<Priority>(std::move(task)))\ \{}
...
\DoxyCodeLine{00203\ \ \ \}}
\DoxyCodeLine{00204\ }
\DoxyCodeLine{00205\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority\ =\ enqueue\_priority::min>}
\DoxyCodeLine{00206\ \ \ executor<Priority>\ get\_executor()}
\DoxyCodeLine{00207\ \ \ \{}
\DoxyCodeLine{00208\ \ \ \ \ \textcolor{keywordflow}{return}\ executor<Priority>\{this-\/>queue.template\ get\_enqueuer(),\ *\textcolor{keyword}{this}\};}
\DoxyCodeLine{00209\ \ \ \}}
\DoxyCodeLine{00210\ }
\DoxyCodeLine{00211\ \ \ std::unique\_ptr<task\_executor>\ get\_executor\_ptr(\mbox{\hyperlink{namespacesrsran_a8773a5775c48bb0867347e2791c954d5}{enqueue\_priority}}\ prio)}
\DoxyCodeLine{00212\ \ \ \{}
...
\DoxyCodeLine{00214\ \ \ \}}
\DoxyCodeLine{00215\ }
\DoxyCodeLine{00216\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00217\ \ \ \textcolor{keyword}{auto}\ get\_enqueuer()}
\DoxyCodeLine{00218\ \ \ \{}
\DoxyCodeLine{00219\ \ \ \ \ \textcolor{keywordflow}{return}\ this-\/>queue.template\ get\_enqueuer<Priority>();}
\DoxyCodeLine{00220\ \ \ \}}
\DoxyCodeLine{00221\ }
\DoxyCodeLine{00222\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00223\ \ \ \textcolor{keyword}{template}\ <\textcolor{keywordtype}{size\_t}...\ Is>}
\DoxyCodeLine{00224\ \ \ std::unique\_ptr<task\_executor>\ get\_executor\_ptr\_impl(\mbox{\hyperlink{namespacesrsran_a8773a5775c48bb0867347e2791c954d5}{enqueue\_priority}}\ priority,\ std::index\_sequence<Is...>\ \textcolor{comment}{/*unused*/})}
\DoxyCodeLine{00225\ \ \ \{}
\DoxyCodeLine{00226\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{size\_t}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ idx\ =\ detail::enqueue\_priority\_to\_queue\_index(priority,\ \textcolor{keyword}{sizeof}...(QueuePolicies));}
\DoxyCodeLine{00227\ \ \ \ \ std::unique\_ptr<task\_executor>\ exec;}
\DoxyCodeLine{00228\ \ \ \ \ (void)std::initializer\_list<int>\{[\textcolor{keyword}{this},\ idx,\ \&exec]()\ \{}
\DoxyCodeLine{00229\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (idx\ ==\ Is)\ \{}
\DoxyCodeLine{00230\ \ \ \ \ \ \ \ \ exec\ =\ std::make\_unique<\mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue_a508fc230676a93fa20a0787974b596ec}{executor}}<detail::queue\_index\_to\_enqueue\_priority(Is,\ \textcolor{keyword}{sizeof}...(QueuePolicies))>>(}
...
\DoxyCodeLine{00242\ \ \ \ \ uint32\_t\ \ \ \ queue\_size\ =\ this-\/>job\_count.load(std::memory\_order\_acquire);}
\DoxyCodeLine{00243\ \ \ \ \ \textcolor{keywordflow}{while}\ (queue\_size\ >\ 0)\ \{}
\DoxyCodeLine{00244\ \ \ \ \ \ \ \textcolor{keywordtype}{unsigned}\ run\_count\ =\ 0;}
\DoxyCodeLine{00245\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (;\ run\_count\ !=\ queue\_size\ and\ queue.queue.try\_pop(task);\ ++run\_count)\ \{}
...
\DoxyCodeLine{00255\ \ \ \ \ \ \ queue\_size\ =\ this-\/>job\_count.fetch\_sub(run\_count,\ std::memory\_order\_acq\_rel)\ -\/\ run\_count;}
\DoxyCodeLine{00256\ \ \ \ \ \}}
\DoxyCodeLine{00257\ \ \ \}}
\DoxyCodeLine{00258\ }
...
\DoxyCodeLine{00265\ \ \ \ \ uint32\_t\ \ \ \ queue\_size\ =\ this-\/>job\_count.load(std::memory\_order\_acquire);}
\DoxyCodeLine{00266\ \ \ \ \ \mbox{\hyperlink{namespacesrsran_ae4f0a84d474968b3437093240d943c33}{unique\_task}}\ dropped\_task;}
\DoxyCodeLine{00267\ \ \ \ \ \textcolor{keywordflow}{while}\ (queue\_size\ >\ 0)\ \{}
\DoxyCodeLine{00268\ \ \ \ \ \ \ \textcolor{keywordtype}{unsigned}\ run\_count\ =\ 0;}
\DoxyCodeLine{00269\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (;\ run\_count\ !=\ queue\_size\ and\ this-\/>queue.queue.try\_pop(dropped\_task);\ ++run\_count)\ \{}
\DoxyCodeLine{00270\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ do\ nothing\ with\ popped\ task.}}
\DoxyCodeLine{00271\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00272\ \ \ \ \ \ \ queue\_size\ =\ this-\/>job\_count.fetch\_sub(run\_count,\ std::memory\_order\_acq\_rel)\ -\/\ run\_count;}
\DoxyCodeLine{00273\ \ \ \ \ \}}
\DoxyCodeLine{00274\ \ \ \}}
\DoxyCodeLine{00275\ }
\DoxyCodeLine{00276\ \ \ \mbox{\hyperlink{namespacesrsran_ae4f0a84d474968b3437093240d943c33}{unique\_task}}\ get\_run\_strand\_task()}
\DoxyCodeLine{00277\ \ \ \{}
...
\DoxyCodeLine{00282\ \ \ detail::strand\_queue<QueuePolicies...>\ queue;}
\DoxyCodeLine{00283\ \};}
\DoxyCodeLine{00284\ }
...
\DoxyCodeLine{00292\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classsrsran_1_1task__strand}{task\_strand}}\ final\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue}{detail::task\_strand\_with\_queue}}<QueuePolicies...>}
\DoxyCodeLine{00293\ \{}
\DoxyCodeLine{00294\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue}{base\_type}}\ =\ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue}{detail::task\_strand\_with\_queue}}<QueuePolicies...>;}
\DoxyCodeLine{00295\ }
\DoxyCodeLine{00296\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00297\ \ \ \textcolor{keyword}{template}\ <enqueue\_priority\ Priority>}
\DoxyCodeLine{00298\ \ \ \textcolor{keyword}{using\ }executor\ =\ \textcolor{keyword}{typename}\ base\_type::template\ executor<Priority>;}
\DoxyCodeLine{00299\ }
\DoxyCodeLine{00300\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Exec,\ \textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00301\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classsrsran_1_1task__strand}{task\_strand}}(Exec\&\&\ executor\_,\ Args\&\&...\ queue\_params)\ :}
\DoxyCodeLine{00302\ \ \ \ \ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__with__queue}{base\_type}}(std::forward<Args>(queue\_params)...),\ out\_exec(std::forward<Exec>(executor\_))}
\DoxyCodeLine{00303\ \ \ \{}
\DoxyCodeLine{00304\ \ \ \}}
\DoxyCodeLine{00305\ }
...
\DoxyCodeLine{00318\ \ \ \ \ \ \ dispatch\_successful\ =\ detail::get\_task\_executor\_ref(out\_exec).execute(this-\/>get\_run\_strand\_task());}
\DoxyCodeLine{00319\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00320\ \ \ \ \ \ \ dispatch\_successful\ =\ detail::get\_task\_executor\_ref(out\_exec).defer(this-\/>get\_run\_strand\_task());}
\DoxyCodeLine{00321\ \ \ \ \ \}}
\DoxyCodeLine{00322\ \ \ \ \ \textcolor{keywordflow}{if}\ (not\ dispatch\_successful)\ \{}
\DoxyCodeLine{00323\ \ \ \ \ \ \ \textcolor{comment}{//\ Unable\ to\ dispatch\ executor\ job\ to\ run\ enqueued\ tasks.}}
\DoxyCodeLine{00324\ \ \ \ \ \ \ this-\/>handle\_failed\_task\_dispatch();}
...
\DoxyCodeLine{00332\ \};}
\DoxyCodeLine{00333\ }
\DoxyCodeLine{00335\ \textcolor{keyword}{template}\ <concurrent\_queue\_policy\ QueuePolicy,\ \textcolor{keyword}{typename}\ OutExec>}
\DoxyCodeLine{00336\ std::unique\_ptr<task\_strand<OutExec,\ QueuePolicy>>\ \mbox{\hyperlink{namespacesrsran_a8dd276390d1ba18b481ef5bf5bb27809}{make\_task\_strand\_ptr}}(OutExec\&\&\ out\_exec,\ \textcolor{keywordtype}{unsigned}\ strand\_queue\_size)}
\DoxyCodeLine{00337\ \{}
...
\DoxyCodeLine{00341\ std::unique\_ptr<task\_strand<OutExec,\ QueuePolicies...>>\ \mbox{\hyperlink{namespacesrsran_a8dd276390d1ba18b481ef5bf5bb27809}{make\_task\_strand\_ptr}}(OutExec\&\&\ \ \ \ \ \ \ \ \ \ \ \ out\_exec,}
\DoxyCodeLine{00342\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ span<const\ unsigned>\ strand\_queue\_sizes)}
\DoxyCodeLine{00343\ \{}
\DoxyCodeLine{00344\ \ \ report\_error\_if\_not(strand\_queue\_sizes.size()\ ==\ \textcolor{keyword}{sizeof}...(QueuePolicies),}
...
\DoxyCodeLine{00349\ \}}
\DoxyCodeLine{00350\ }
\DoxyCodeLine{00352\ \textcolor{keyword}{template}\ <concurrent\_queue\_policy\ QueuePolicy>}
\DoxyCodeLine{00353\ \textcolor{keyword}{using\ }\mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl}{shared\_strand\_executor}}\ =\ \mbox{\hyperlink{classsrsran_1_1detail_1_1task__strand__executor__impl}{detail::task\_strand\_executor\_impl<QueuePolicy,\ std::shared\_ptr<base\_task\_strand>}}>;}
\DoxyCodeLine{00354\ }
\DoxyCodeLine{00356\ \textcolor{keyword}{template}\ <concurrent\_queue\_policy\ QueuePolicy,\ \textcolor{keyword}{typename}\ OutExec>}
\DoxyCodeLine{00357\ std::unique\_ptr<task\_executor>\ \mbox{\hyperlink{namespacesrsran_a3f68f327cab5b905278d0d9af556a407}{make\_strand\_executor\_ptr}}(OutExec\&\&\ out\_exec,\ \textcolor{keywordtype}{unsigned}\ queue\_size)}
\DoxyCodeLine{00358\ \{}
...
\DoxyCodeLine{00360\ \ \ \textcolor{keyword}{auto}\ enqueuer\ =\ strand-\/>template\ get\_enqueuer<enqueue\_priority::max>();}
\DoxyCodeLine{00361\ }
...
\DoxyCodeLine{00366\ }
\DoxyCodeLine{00367\ \textcolor{keyword}{template}\ <\mbox{\hyperlink{namespacesrsran_a08f31ae01c088c535705650443feec0c}{concurrent\_queue\_policy}}...\ QueuePolicies,\ \textcolor{keyword}{typename}\ OutExec,\ \textcolor{keywordtype}{size\_t}...\ Is>}
...
\DoxyCodeLine{00374\ \ \ \ \ \ \ \ \ \ \ strand\_shared-\/>template\ get\_enqueuer<detail::queue\_index\_to\_enqueue\_priority(Is,\ \textcolor{keyword}{sizeof}...(QueuePolicies))>(),}
...
\DoxyCodeLine{00390\ std::vector<std::unique\_ptr<task\_executor>>\ \mbox{\hyperlink{namespacesrsran_a2dbc1d7f9cce43fdcf1dcdb3c290a99b}{make\_strand\_executor\_ptrs}}(OutExec\&\&\ out\_exec,\ \mbox{\hyperlink{classsrsran_1_1span}{span<const\ unsigned>}}\ qsizes)}
\DoxyCodeLine{00391\ \{}
\DoxyCodeLine{00392\ \ \ std::shared\_ptr<\mbox{\hyperlink{classsrsran_1_1task__strand}{task\_strand}}<OutExec,\ QueuePolicies...>>\ strand\_shared\ =}
\DoxyCodeLine{00393\ \ \ \ \ \ \ \mbox{\hyperlink{namespacesrsran_a8dd276390d1ba18b481ef5bf5bb27809}{make\_task\_strand\_ptr}}<QueuePolicies...>(std::forward<OutExec>(out\_exec),\ qsizes);}
\DoxyCodeLine{00394\ }
...
\DoxyCodeLine{00399\ }
\DoxyCodeLine{00400\ \textcolor{keyword}{constexpr}\ \textcolor{keywordtype}{size\_t}\ MAX\_QUEUES\_PER\_STRAND\ =\ 3;}
\DoxyCodeLine{00401\ }
...
\DoxyCodeLine{00407\ make\_strand\_executors\_iter\_helper(OutExec\&\&\ out\_exec,\ span<const\ concurrent\_queue\_params>\ strand\_queues)}
\DoxyCodeLine{00408\ \{}
\DoxyCodeLine{00409\ \ \ \mbox{\hyperlink{namespacesrsran_a630688b51219f81c5a47ec5650326afc}{report\_fatal\_error}}(\textcolor{stringliteral}{"{}Strands\ with\ equal\ or\ more\ than\ \{\}\ queues\ are\ not\ supported"{}},\ MAX\_QUEUES\_PER\_STRAND);}
...
\DoxyCodeLine{00417\ make\_strand\_executors\_iter\_helper(OutExec\&\&\ out\_exec,\ span<const\ concurrent\_queue\_params>\ strand\_queues)}
\DoxyCodeLine{00418\ \{}
\DoxyCodeLine{00419\ \ \ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{size\_t}\ Is\ =\ \textcolor{keyword}{sizeof}...(QueuePolicies);}
\DoxyCodeLine{00420\ \ \ \textcolor{keywordflow}{if}\ (strand\_queues.empty()\ or\ Is\ >\ strand\_queues.size())\ \{}
\DoxyCodeLine{00421\ \ \ \ \ \textcolor{keywordflow}{return}\ \{\};}
\DoxyCodeLine{00422\ \ \ \}}
\DoxyCodeLine{00423\ \ \ \textcolor{keywordflow}{if}\ (Is\ ==\ strand\_queues.size())\ \{}
\DoxyCodeLine{00424\ \ \ \ \ std::array<unsigned,\ Is>\ strand\_queue\_sizes;}
...
\DoxyCodeLine{00427\ \ \ \ \ \}}
\DoxyCodeLine{00428\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacesrsran_a2dbc1d7f9cce43fdcf1dcdb3c290a99b}{make\_strand\_executor\_ptrs}}<QueuePolicies...>(std::forward<OutExec>(out\_exec),}
\DoxyCodeLine{00429\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ span<const\ unsigned>(strand\_queue\_sizes));}
\DoxyCodeLine{00430\ \ \ \}}
\DoxyCodeLine{00431\ }
...
\DoxyCodeLine{00442\ \ \ \ \ \ \ \mbox{\hyperlink{namespacesrsran_a630688b51219f81c5a47ec5650326afc}{report\_fatal\_error}}(\textcolor{stringliteral}{"{}Unsupported\ queue\ policy."{}});}
\DoxyCodeLine{00443\ \ \ \}}
...
\DoxyCodeLine{00451\ std::vector<std::unique\_ptr<task\_executor>>\ \mbox{\hyperlink{namespacesrsran_a2dbc1d7f9cce43fdcf1dcdb3c290a99b}{make\_strand\_executor\_ptrs}}(OutExec\&\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ out\_exec,}
\DoxyCodeLine{00452\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classsrsran_1_1span}{span<const\ concurrent\_queue\_params>}}\ strand\_queues)}
\DoxyCodeLine{00453\ \{}
