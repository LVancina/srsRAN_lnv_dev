...
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#}\textcolor{preprocessor}{include}\ \textcolor{preprocessor}{"{}srsran/ran/uci/uci\_payload\_type.h"{}}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keyword}{namespace}\ \mbox{\hyperlink{namespacesrsran}{srsran}}\ \{}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{comment}{///\ \(\backslash\)brief\ Calculates\ the\ UCI\ part\ 2\ from\ UCI\ part\ 1.}}
\DoxyCodeLine{00032\ \textcolor{comment}{///\ \(\backslash\)param[in]\ part1\ UCI\ part\ 1\ decoded\ data.}}
\DoxyCodeLine{00033\ \textcolor{comment}{///\ \(\backslash\)param[in]\ descr\ UCI\ part\ 1\ parameters\ correspondence\ to\ UCI\ part\ 2\ size.}}
\DoxyCodeLine{00034\ \textcolor{comment}{///\ \(\backslash\)return\ The\ size\ of\ UCI\ part\ 2\ payload.}}
\DoxyCodeLine{00035\ \textcolor{keywordtype}{unsigned}\ \mbox{\hyperlink{namespacesrsran_a152027a2a5a7a11e4d8ddba3e5bc2337}{uci\_part2\_get\_size}}(\textcolor{keyword}{const}\ uci\_payload\_type\&\ part1,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1uci__part2__size__description}{uci\_part2\_size\_description}}\&\ descr);}
\DoxyCodeLine{00036\ }
