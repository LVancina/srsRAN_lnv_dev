...
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#include\ "{}srsran/e2/e2\_factory.h"{}}}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ "{}srsran/gateways/sctp\_network\_gateway.h"{}}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#include\ "{}srsran/pcap/dlt\_pcap.h"{}}}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#include\ "{}srsran/support/io/io\_broker.h"{}}}
\DoxyCodeLine{00030\ }
...
\DoxyCodeLine{00040\ \ \ \mbox{\hyperlink{classsrsran_1_1e2ap__network__adapter}{e2ap\_network\_adapter}}(\mbox{\hyperlink{classsrsran_1_1io__broker}{io\_broker}}\&\ broker\_,\ \mbox{\hyperlink{classsrsran_1_1dlt__pcap}{dlt\_pcap}}\&\ pcap\_)\ :\ broker(broker\_),\ pcap(pcap\_)\ \{\}}
\DoxyCodeLine{00041\ }
...
\DoxyCodeLine{00120\ \ \ \textcolor{keywordtype}{void}\ on\_new\_message(\textcolor{keyword}{const}\ e2\_message\&\ msg)\textcolor{keyword}{\ override}}
\DoxyCodeLine{00121\ \textcolor{keyword}{\ \ }\{}
\DoxyCodeLine{00122\ \ \ \ \ srsran\_assert(packer,\ \textcolor{stringliteral}{"{}E2AP\ ASN1\ packer\ disconnected"{}});}
...
\DoxyCodeLine{00127\ \ \ \textcolor{keywordtype}{void}\ on\_new\_pdu(byte\_buffer\ pdu)\textcolor{keyword}{\ override}}
\DoxyCodeLine{00128\ \textcolor{keyword}{\ \ }\{}
\DoxyCodeLine{00129\ \ \ \ \ srsran\_assert(packer,\ \textcolor{stringliteral}{"{}E2AP\ ASN1\ packer\ disconnected"{}});}
...
\DoxyCodeLine{00134\ \ \ \textcolor{keywordtype}{void}\ handle\_message(\textcolor{keyword}{const}\ e2\_message\&\ msg)\textcolor{keyword}{\ override}}
\DoxyCodeLine{00135\ \textcolor{keyword}{\ \ }\{}
\DoxyCodeLine{00136\ \ \ \ \ srsran\_assert(e2ap\_msg\_handler,\ \textcolor{stringliteral}{"{}E2AP\ msg\ handler\ not\ set."{}});}
\DoxyCodeLine{00137\ \ \ \ \ e2ap\_msg\_handler-\/>\mbox{\hyperlink{classsrsran_1_1e2__message__handler_a25894c4dedb94645ebeab8c0ca0cb7cc}{handle\_message}}(msg);}
\DoxyCodeLine{00138\ \ \ \}}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00142\ \ \ \ \ srsran\_assert(event\_handler,\ \textcolor{stringliteral}{"{}E2AP\ event\ handler\ not\ set."{}});}
...
\DoxyCodeLine{00150\ \ \ \}}
\DoxyCodeLine{00151\ }
\DoxyCodeLine{00152\ \ \ io\_broker\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ broker;}
\DoxyCodeLine{00153\ \ \ dlt\_pcap\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ pcap;}
\DoxyCodeLine{00154\ \ \ std::unique\_ptr<e2ap\_packer>\ \ \ \ \ \ \ \ \ \ packer;}
\DoxyCodeLine{00155\ \ \ std::unique\_ptr<sctp\_network\_gateway>\ gateway;}
\DoxyCodeLine{00156\ \ \ sctp\_network\_gateway\_controller*\ \ \ \ \ \ gateway\_ctrl\_handler;}
\DoxyCodeLine{00157\ \ \ sctp\_network\_gateway\_data\_handler*\ \ \ \ gateway\_data\_handler;}
\DoxyCodeLine{00158\ \ \ e2\_message\_handler*\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ e2ap\_msg\_handler;}
\DoxyCodeLine{00159\ \ \ e2\_event\_handler*\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ event\_handler;}
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00161\ \ \ \mbox{\hyperlink{classsrslog_1_1detail_1_1logger__impl}{srslog::basic\_logger}}\&\ logger\ =\ srslog::fetch\_basic\_logger(\textcolor{stringliteral}{"{}SCTP-\/GW"{}});}
\DoxyCodeLine{00162\ \};}
\DoxyCodeLine{00163\ }
