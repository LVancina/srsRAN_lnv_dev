...
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \textcolor{preprocessor}{\#}\textcolor{preprocessor}{include}\ \mbox{\hyperlink{gtpu__tunnel__logger_8h}{"{}gtpu\_tunnel\_logger.h"{}}}}
...
\DoxyCodeLine{00074\ \textcolor{keyword}{enum}\ \textcolor{keyword}{class}\ gtpu\_extension\_header\_type\ :\ uint8\_t\ \{}
...
\DoxyCodeLine{00131\ \textcolor{keyword}{enum}\ \textcolor{keyword}{class}\ gtpu\_comprehension\ :\ uint8\_t\ \{}
...
\DoxyCodeLine{00139\ \textcolor{keyword}{enum}\ \textcolor{keyword}{class}\ gtpu\_information\_element\_type\ :\ uint8\_t\ \{}
...
\DoxyCodeLine{00162\ \};}
\DoxyCodeLine{00163\ }
\DoxyCodeLine{00164\ \textcolor{comment}{///\ Base\ class\ for\ GTP-\/U\ extension\ headers}}
...
\DoxyCodeLine{00168\ \};}
\DoxyCodeLine{00169\ }
\DoxyCodeLine{00170\ \textcolor{comment}{///\ GTP-\/U\ information\ element\ for\ "{}Recovery"{}.\ See\ TS\ 29.281\ Sec.\ 8.2}}
\DoxyCodeLine{00171\ \textcolor{comment}{///\ IE\ format:\ TV}}
\DoxyCodeLine{00172\ \textcolor{keyword}{struct}\ \mbox{\hyperlink{structsrsran_1_1gtpu__ie__recovery}{gtpu\_ie\_recovery}}\ \{}
\DoxyCodeLine{00173\ \ \ \textcolor{comment}{///\ The\ value\ of\ the\ restart\ counter\ shall\ be\ set\ to\ 0\ by\ the\ sending\ entity\ and\ ignored\ by\ the\ receiving\ entity.\ This}}
\DoxyCodeLine{00174\ \ \ \textcolor{comment}{///\ information\ element\ is\ used\ in\ GTP\ user\ plane\ due\ to\ backwards\ compatibility\ reasons.}}
...
\DoxyCodeLine{00176\ \};}
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00178\ \textcolor{comment}{///\ GTP-\/U\ information\ element\ for\ "{}Private\ Extension"{}.\ See\ TS\ 29.281\ Sec.\ 8.6}}
\DoxyCodeLine{00179\ \textcolor{comment}{///\ IE\ format:\ TLV}}
...
\DoxyCodeLine{00181\ \ \ \textcolor{comment}{///\ The\ Extension\ Identifier\ is\ a\ value\ defined\ in\ the\ Private\ Enterprise\ number\ list}}
...
\DoxyCodeLine{00183\ \ \ \textcolor{comment}{///\ Custom\ extension}}
...
\DoxyCodeLine{00185\ \};}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \textcolor{comment}{///\ GTP-\/U\ header,\ including\ extensions}}
...
\DoxyCodeLine{00196\ \ \ \textcolor{comment}{///\ This\ field\ indicates\ the\ type\ of\ GTP-\/U\ message.}}
...
\DoxyCodeLine{00198\ \ \ \textcolor{comment}{///\ This\ field\ indicates\ the\ length\ in\ octets\ of\ the\ payload,\ i.e.\ the\ rest\ of\ the\ packet\ following\ the\ mandatory}}
\DoxyCodeLine{00199\ \ \ \textcolor{comment}{///\ part\ of\ the\ GTP\ header\ (that\ is\ the\ first\ 8\ octets).\ The\ Sequence\ Number,\ the\ N-\/PDU\ Number\ or\ any\ Extension}}
\DoxyCodeLine{00200\ \ \ \textcolor{comment}{///\ headers\ shall\ be\ considered\ to\ be\ part\ of\ the\ payload,\ i.e.\ included\ in\ the\ length\ count.}}
\DoxyCodeLine{00201\ \ \ uint16\_t\ \mbox{\hyperlink{structsrsran_1_1gtpu__header_a39886826ab123b8baa2f8e513de6ace1}{length}}\ =\ 0;}
\DoxyCodeLine{00202\ \ \ \textcolor{comment}{///\ Tunnel\ Endpoint\ Identifier.}}
\DoxyCodeLine{00203\ \ \ gtpu\_teid\_t\ \mbox{\hyperlink{structsrsran_1_1gtpu__header_ae3b4c852c6de6464163d17b94cbf2d93}{teid}}\ =\ \{\};}
\DoxyCodeLine{00204\ \ \ \textcolor{comment}{///\ Sequence\ Number.}}
\DoxyCodeLine{00205\ \ \ uint16\_t\ \mbox{\hyperlink{structsrsran_1_1gtpu__header_ae75b20f3643bc9e7649f03748762eb3a}{seq\_number}}\ =\ 0;}
\DoxyCodeLine{00206\ \ \ \textcolor{comment}{///\ N-\/PDU\ Number.}}
\DoxyCodeLine{00207\ \ \ uint8\_t\ \mbox{\hyperlink{structsrsran_1_1gtpu__header_a5057bffec189b15d09bb2ac0dfccee83}{n\_pdu}}\ =\ 0;}
\DoxyCodeLine{00208\ \ \ \textcolor{comment}{///\ Next\ Extension\ Header\ Type:\ This\ field\ defines\ the\ type\ of\ Extension\ Header\ that\ follows\ this\ field\ in\ the}}
\DoxyCodeLine{00209\ \ \ \textcolor{comment}{///\ GTP-\/PDU.}}
...
\DoxyCodeLine{00211\ \ \ \textcolor{comment}{///\ Collection\ of\ included\ GTP-\/U\ header\ extensions}}
\DoxyCodeLine{00212\ \ \ \mbox{\hyperlink{classsrsran_1_1static__vector}{static\_vector}}<\mbox{\hyperlink{structsrsran_1_1gtpu__extension__header}{gtpu\_extension\_header}},\ GTPU\_MAX\_NUM\_HEADER\_EXTENSIONS>\ \mbox{\hyperlink{structsrsran_1_1gtpu__header_a2dfe989911e7a17a673901a058d3144c}{ext\_list}};}
\DoxyCodeLine{00213\ \};}
\DoxyCodeLine{00214\ }
\DoxyCodeLine{00215\ \textcolor{comment}{///\ Intermediate\ representation\ of\ a\ received\ GTP-\/U\ PDU\ to\ access\ the\ unpacked\ header\ and\ to\ the\ raw\ content\ of\ the}}
\DoxyCodeLine{00216\ \textcolor{comment}{///\ extension\ headers.\ This\ container\ holds\ a\ buffer\ with\ the\ original\ PDU\ to\ which\ the\ views\ of\ the\ extension\ header}}
\DoxyCodeLine{00217\ \textcolor{comment}{///\ content\ are\ mapped.\ After\ processing\ the\ extension\ headers,\ the\ T-\/PDU\ can\ be\ extracted\ via\ \(\backslash\)c\ gtpu\_extract\_t\_pdu}}
\DoxyCodeLine{00218\ \textcolor{comment}{///\ which\ advances\ the\ PDU\ buffer\ to\ the\ start\ of\ the\ T-\/PDU\ according\ to\ \(\backslash\)c\ hdr\_len.}}
\DoxyCodeLine{00219\ \textcolor{keyword}{struct}\ \mbox{\hyperlink{structsrsran_1_1gtpu__dissected__pdu}{gtpu\_dissected\_pdu}}\ \{}
\DoxyCodeLine{00220\ \ \ \textcolor{comment}{///\ Storage\ of\ the\ original\ GTP-\/U\ PDU\ to\ which\ the\ views\ of\ the\ extension\ header\ content\ is\ mapped}}
...
\DoxyCodeLine{00222\ \ \ \textcolor{comment}{///\ Access\ to\ the\ dissected\ content\ of\ the\ GTP-\/U\ PDU}}
...
\DoxyCodeLine{00224\ \ \ \textcolor{comment}{///\ Total\ header\ length\ (including\ all\ extension\ headers);\ marks\ the\ start\ of\ the\ T-\/PDU.}}
\DoxyCodeLine{00225\ \ \ \mbox{\hyperlink{structsrsran_1_1gtpu__dissected__pdu_a79e40cad41127dfc925f3d9921479845}{size\_t}}\ \mbox{\hyperlink{structsrsran_1_1gtpu__dissected__pdu_a79e40cad41127dfc925f3d9921479845}{hdr\_len}}\ =\ 0;}
\DoxyCodeLine{00226\ \};}
\DoxyCodeLine{00227\ }
\DoxyCodeLine{00228\ \textcolor{keywordtype}{bool}\ gtpu\_read\_teid(uint32\_t\&\ teid,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classsrsran_1_1byte__buffer}{byte\_buffer}}\&\ pdu,\ srslog::basic\_logger\&\ logger);}
\DoxyCodeLine{00229\ }
\DoxyCodeLine{00230\ \textcolor{comment}{///\ Creates\ a\ dissected\ representation\ of\ a\ raw\ GTP-\/U\ PDU\ with\ access\ to\ the\ unpacked\ header\ and\ to\ the\ raw\ content\ of}}
\DoxyCodeLine{00231\ \textcolor{comment}{///\ the\ extension\ headers\ for\ further\ processing\ of\ the\ extensions.}}
\DoxyCodeLine{00232\ \textcolor{comment}{///\ \(\backslash\)param[out]\ dissected\_pdu\ Reference\ to\ an\ object\ into\ which\ the\ dissected\ GTP-\/U\ PDU\ shall\ be\ filled/moved.}}
\DoxyCodeLine{00233\ \textcolor{comment}{///\ \(\backslash\)param[in]\ raw\_pdu\ The\ raw\ GTP-\/U\ PDU\ that\ shall\ be\ dissected.}}
\DoxyCodeLine{00234\ \textcolor{comment}{///\ \(\backslash\)param[in]\ logger\ Access\ to\ the\ logger.}}
\DoxyCodeLine{00235\ \textcolor{comment}{///\ \(\backslash\)return\ True\ if\ the\ dissection\ was\ successful,\ False\ otherwise.}}
\DoxyCodeLine{00236\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacesrsran_a91232028f75840975a4fbbd0005a15cf}{gtpu\_dissect\_pdu}}(\mbox{\hyperlink{structsrsran_1_1gtpu__dissected__pdu}{gtpu\_dissected\_pdu}}\&\ dissected\_pdu,\ \mbox{\hyperlink{classsrsran_1_1byte__buffer}{byte\_buffer}}\ raw\_pdu,\ gtpu\_tunnel\_logger\&\ logger);}
\DoxyCodeLine{00237\ }
\DoxyCodeLine{00238\ \textcolor{comment}{///\ Prepends\ the\ GTP-\/U\ header\ in\ front\ of\ a\ GTP-\/U\ PDU.}}
\DoxyCodeLine{00239\ \textcolor{comment}{///\ Ref:\ TS\ 29.281\ Sec.}}
\DoxyCodeLine{00240\ \textcolor{comment}{///\ \(\backslash\)param[out]\ pdu\ Buffer\ of\ the\ GTP-\/U\ PDU\ to\ which\ the\ information\ element\ shall\ be\ prepended.}}
\DoxyCodeLine{00241\ \textcolor{comment}{///\ \(\backslash\)param[in]\ header\ The\ GTP-\/U\ header.}}
\DoxyCodeLine{00242\ \textcolor{comment}{///\ \(\backslash\)param[in]\ logger\ Access\ to\ the\ logger.}}
\DoxyCodeLine{00243\ \textcolor{comment}{///\ \(\backslash\)return\ True\ if\ write\ was\ successful,\ False\ otherwise.}}
\DoxyCodeLine{00244\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacesrsran_afd81a8c24d4de479c6bd3887e97d640e}{gtpu\_write\_header}}(\mbox{\hyperlink{classsrsran_1_1byte__buffer}{byte\_buffer}}\&\ pdu,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1gtpu__header}{gtpu\_header}}\&\ header,\ gtpu\_tunnel\_logger\&\ logger);}
\DoxyCodeLine{00245\ }
\DoxyCodeLine{00246\ \textcolor{comment}{///\ Append\ the\ "{}recovery"{}\ information\ element\ to\ a\ GTP-\/U\ PDU.}}
\DoxyCodeLine{00247\ \textcolor{comment}{///\ Ref:\ TS\ 29.281\ Sec.\ 8.2.}}
\DoxyCodeLine{00248\ \textcolor{comment}{///\ \(\backslash\)param[out]\ pdu\ Buffer\ of\ the\ GTP-\/U\ PDU\ to\ which\ the\ information\ element\ shall\ be\ appended.}}
\DoxyCodeLine{00249\ \textcolor{comment}{///\ \(\backslash\)param[in]\ ie\_recovery\ The\ information\ element\ "{}recovery"{}.}}
\DoxyCodeLine{00250\ \textcolor{comment}{///\ \(\backslash\)param[in]\ logger\ Access\ to\ the\ logger.}}
\DoxyCodeLine{00251\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacesrsran_a772151f60a31780b164f7b439287d7fa}{gtpu\_write\_ie\_recovery}}(\mbox{\hyperlink{classsrsran_1_1byte__buffer}{byte\_buffer}}\&\ pdu,\ \mbox{\hyperlink{structsrsran_1_1gtpu__ie__recovery}{gtpu\_ie\_recovery}}\&\ ie\_recovery,\ gtpu\_tunnel\_logger\&\ logger);}
\DoxyCodeLine{00252\ }
\DoxyCodeLine{00253\ \textcolor{comment}{///\ Append\ the\ "{}private\ extension"{}\ information\ element\ to\ a\ GTP-\/U\ PDU.}}
\DoxyCodeLine{00254\ \textcolor{comment}{///\ Ref:\ TS\ 29.281\ Sec.\ 8.6.}}
\DoxyCodeLine{00255\ \textcolor{comment}{///\ \(\backslash\)param[out]\ pdu\ Buffer\ of\ the\ GTP-\/U\ PDU\ to\ which\ the\ information\ element\ shall\ be\ appended.}}
\DoxyCodeLine{00256\ \textcolor{comment}{///\ \(\backslash\)param[in]\ ie\_recovery\ The\ information\ element\ "{}private\ extension"{}.}}
\DoxyCodeLine{00257\ \textcolor{comment}{///\ \(\backslash\)param[in]\ logger\ Access\ to\ the\ logger.}}
...
\DoxyCodeLine{00260\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ gtpu\_tunnel\_logger\&\ \ \ \ \ \ \ \ logger);}
\DoxyCodeLine{00261\ }
\DoxyCodeLine{00262\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacesrsran_acfd2dd826547652e6c45c64c4c582626}{gtpu\_supported\_flags\_check}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1gtpu__header}{gtpu\_header}}\&\ header,\ gtpu\_tunnel\_logger\&\ logger);}
\DoxyCodeLine{00263\ \textcolor{keywordtype}{bool}\ gtpu\_supported\_msg\_type\_check(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1gtpu__header}{gtpu\_header}}\&\ header,\ gtpu\_tunnel\_logger\&\ logger);}
\DoxyCodeLine{00264\ \textcolor{keywordtype}{bool}\ gtpu\_extension\_header\_comprehension\_check(\textcolor{keyword}{const}\ gtpu\_extension\_header\_type\&\ type,\ gtpu\_tunnel\_logger\&\ logger);}
\DoxyCodeLine{00265\ }
\DoxyCodeLine{00266\ \textcolor{comment}{///\ Extracts\ the\ T-\/PDU\ of\ a\ dissected\ GTP-\/U\ PDU\ by\ advancing\ its\ internal\ PDU\ buffer\ by\ the\ header\ length\ and\ returning}}
\DoxyCodeLine{00267\ \textcolor{comment}{///\ that\ object.\ Any\ other\ content\ of\ the\ dissected\ PDU\ (e.g.\ header\ extensions)\ will\ be\ invalidated.}}
\DoxyCodeLine{00268\ \textcolor{comment}{///\ \(\backslash\)param\ dissected\_pdu\ The\ dissected\ GTP-\/U\ PDU\ from\ which\ the\ T-\/PDU\ shall\ be\ extracted.}}
\DoxyCodeLine{00269\ \textcolor{comment}{///\ \(\backslash\)return\ The\ T-\/PDU\ of\ the\ dissected\ GTP-\/U\ PDU.}}
...
\DoxyCodeLine{00279\ \textcolor{keyword}{struct}\ formatter<srsran::gtpu\_header::gtpu\_flags>\ \{}
...
\DoxyCodeLine{00287\ \ \ \textcolor{keyword}{auto}\ format(\textcolor{keyword}{const}\ srsran::gtpu\_header::gtpu\_flags\&\ flags,\ FormatContext\&\ ctx)}
...
\DoxyCodeLine{00301\ \textcolor{keyword}{struct}\ formatter<srsran::gtpu\_header>\ \{}
...
\DoxyCodeLine{00309\ \ \ \textcolor{keyword}{auto}\ format(\textcolor{keyword}{const}\ srsran::gtpu\_header\&\ hdr,\ FormatContext\&\ ctx)\ -\/>\ \textcolor{keyword}{decltype}(std::declval<FormatContext>().out())}
\DoxyCodeLine{00310\ \ \ \{}
\DoxyCodeLine{00311\ \ \ \ \ \textcolor{keywordflow}{return}\ format\_to(ctx.out(),\ \textcolor{stringliteral}{"{}\{\}\ len=\{\}\ teid=\{:\#x\}"{}},\ hdr.flags,\ hdr.length,\ hdr.teid);}
\DoxyCodeLine{00312\ \ \ \}}
\DoxyCodeLine{00313\ \};}
\DoxyCodeLine{00314\ }
\DoxyCodeLine{00315\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00316\ \textcolor{keyword}{struct}\ formatter<srsran::gtpu\_extension\_header\_type>\ \{}
