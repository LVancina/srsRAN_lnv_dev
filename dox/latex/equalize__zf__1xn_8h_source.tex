...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#if\ defined(\_\_AVX2\_\_)\ ||\ defined(HAVE\_NEON)}}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#include\ "{}../../../srsvec/simd.h"{}}}
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ \_\_AVX2\_\_\ ||\ HAVE\_NEON}}
\DoxyCodeLine{00033\ }
...
\DoxyCodeLine{00045\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacesrsran_a774ca6a7bd234a4276aa3e18869c0a9f}{equalize\_zf\_1xn}}(\mbox{\hyperlink{classsrsran_1_1tensor}{channel\_equalizer::re\_list}}\&\ \ \ \ \ \ \ \ \ \ \ eq\_symbols,}
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classsrsran_1_1tensor}{channel\_equalizer::noise\_var\_list}}\&\ \ \ \ noise\_vars,}
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classsrsran_1_1tensor}{channel\_equalizer::re\_list}}\&\ \ \ \ \ ch\_symbols,}
\DoxyCodeLine{00048\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classsrsran_1_1tensor}{channel\_equalizer::ch\_est\_list}}\&\ ch\_estimates,}
...
\DoxyCodeLine{00053\ \ \ \textcolor{keywordtype}{unsigned}\ nof\_re\ =\ ch\_symbols.\mbox{\hyperlink{classsrsran_1_1tensor_a8e4d9592972c991c7fede35886d09398}{get\_dimension\_size}}(channel\_equalizer::re\_list::dims::re);}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \ \ \textcolor{comment}{//\ Views\ over\ the\ output\ data.}}
\DoxyCodeLine{00056\ \ \ \mbox{\hyperlink{classsrsran_1_1span}{span<float>}}\ nvars\_out\ \ \ =\ noise\_vars.\mbox{\hyperlink{classsrsran_1_1tensor_aa4379387498edc2307a09f6a60b85c8a}{get\_view}}(\{\});}
\DoxyCodeLine{00057\ \ \ \mbox{\hyperlink{classsrsran_1_1span}{span<cf\_t>}}\ \ symbols\_out\ =\ eq\_symbols.\mbox{\hyperlink{classsrsran_1_1tensor_aa4379387498edc2307a09f6a60b85c8a}{get\_view}}(\{\});}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \textcolor{keywordtype}{unsigned}\ i\_re\ =\ 0;}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ \textcolor{preprocessor}{\#if\ defined(\_\_AVX2\_\_)\ ||\ defined(HAVE\_NEON)}}
\DoxyCodeLine{00062\ \ \ \textcolor{comment}{//\ Views\ over\ the\ input\ data.}}
\DoxyCodeLine{00063\ \ \ std::array<span<const\ cf\_t>,\ MAX\_PORTS>\ port\_symbols;}
\DoxyCodeLine{00064\ \ \ std::array<span<const\ cf\_t>,\ MAX\_PORTS>\ port\_ests;}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{unsigned}\ i\_port\ =\ 0;\ i\_port\ !=\ RX\_PORTS;\ ++i\_port)\ \{}
\DoxyCodeLine{00067\ \ \ \ \ port\_symbols[i\_port]\ =\ ch\_symbols.\mbox{\hyperlink{classsrsran_1_1tensor_aa4379387498edc2307a09f6a60b85c8a}{get\_view}}(\{i\_port\});}
\DoxyCodeLine{00068\ \ \ \ \ port\_ests[i\_port]\ \ \ \ =\ ch\_estimates.\mbox{\hyperlink{classsrsran_1_1tensor_aa4379387498edc2307a09f6a60b85c8a}{get\_view}}(\{i\_port,\ 0\});}
\DoxyCodeLine{00069\ \ \ \}}
\DoxyCodeLine{00070\ }
...
\DoxyCodeLine{00073\ \ \ simd\_f\_t\ infinity\ =\ srsran\_simd\_f\_set1(std::numeric\_limits<float>::infinity());}
\DoxyCodeLine{00074\ }
...
\DoxyCodeLine{00122\ \ \ \}}
\DoxyCodeLine{00123\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ \_\_AVX2\_\_\ ||\ HAVE\_NEON}}
\DoxyCodeLine{00124\ }
...
\DoxyCodeLine{00127\ \ \ \ \ \mbox{\hyperlink{namespacesrsran_adb0c7723c7e69c78add18ca453dd1dbc}{cf\_t}}\ \ re\_out\ \ \ \ =\ 0.0F;}
\DoxyCodeLine{00128\ }
...
\DoxyCodeLine{00131\ \ \ \ \ \ \ \mbox{\hyperlink{namespacesrsran_adb0c7723c7e69c78add18ca453dd1dbc}{cf\_t}}\ re\_in\ \ =\ ch\_symbols[\{i\_re,\ i\_port\}];}
\DoxyCodeLine{00132\ \ \ \ \ \ \ \mbox{\hyperlink{namespacesrsran_adb0c7723c7e69c78add18ca453dd1dbc}{cf\_t}}\ ch\_est\ =\ ch\_estimates[\{i\_re,\ i\_port\}];}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \ \ \ \ \ \ \textcolor{comment}{//\ Compute\ the\ channel\ square\ norm,\ by\ accumulating\ the\ channel\ square\ absolute\ values.}}
\DoxyCodeLine{00135\ \ \ \ \ \ \ ch\_mod\_sq\ +=\ \mbox{\hyperlink{namespacesrsran_a45740ff6c7d613055e252f31ce2b7939}{abs\_sq}}(ch\_est);}
\DoxyCodeLine{00136\ }
...
\DoxyCodeLine{00144\ \ \ \ \ nvars\_out[i\_re]\ \ \ =\ std::numeric\_limits<float>::infinity();}
\DoxyCodeLine{00145\ }
