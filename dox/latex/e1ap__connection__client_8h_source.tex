...
\DoxyCodeLine{00035\ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classsrsran_1_1srs__cu__up_1_1e1ap__connection__client}{\string~e1ap\_connection\_client}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00041\ \ \ \textcolor{keyword}{virtual}\ std::unique\_ptr<e1ap\_message\_notifier>}
\DoxyCodeLine{00042\ \ \ \mbox{\hyperlink{classsrsran_1_1srs__cu__up_1_1e1ap__connection__client_a98b15c120852928dcc56a684a2903aed}{handle\_cu\_up\_connection\_request}}(std::unique\_ptr<e1ap\_message\_notifier>\ cu\_up\_rx\_pdu\_notifier)\ =\ 0;}
\DoxyCodeLine{00043\ \};}
\DoxyCodeLine{00044\ }
