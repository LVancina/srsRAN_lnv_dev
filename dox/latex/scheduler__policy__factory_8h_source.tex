\doxysection{scheduler\+\_\+policy\+\_\+factory.\+h}
\hypertarget{scheduler__policy__factory_8h_source}{}\label{scheduler__policy__factory_8h_source}\index{lib/scheduler/policy/scheduler\_policy\_factory.h@{lib/scheduler/policy/scheduler\_policy\_factory.h}}
...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structsrsran_1_1scheduler__strategy__params}{scheduler\_strategy\_params}}\ \{}
\DoxyCodeLine{00030\ \ \ std::string\ \ \ \ \ \ \ \ \ \ \ strategy\ =\ \textcolor{stringliteral}{"{}time\_rr"{}};}
\DoxyCodeLine{00031\ \ \ \mbox{\hyperlink{classsrslog_1_1detail_1_1logger__impl}{srslog::basic\_logger}}*\ logger;}
\DoxyCodeLine{00032\ \};}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ std::unique\_ptr<scheduler\_policy>\ create\_scheduler\_strategy(\textcolor{keyword}{const}\ \mbox{\hyperlink{structsrsran_1_1scheduler__strategy__params}{scheduler\_strategy\_params}}\&\ \mbox{\hyperlink{structparams}{params}});}
\DoxyCodeLine{00035\ }
