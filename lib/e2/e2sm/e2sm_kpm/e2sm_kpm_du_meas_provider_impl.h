...
private:
  ...
  metric_meas_getter_func_t get_drb_ul_mean_throughput_lnv_test;    //lnv - adding for experimental purposes
  metric_meas_getter_func_t get_drb_ul_data_vol_lnv_test;    //lnv - adding for experimental purposes
