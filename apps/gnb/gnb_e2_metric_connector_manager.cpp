...
//LNV - This function creates an e2_du_metric_connector for each DU currently active
e2_metric_connector_manager::e2_metric_connector_manager(const gnb_appconfig& appcfg)
{
  for (unsigned i = 0, e = appcfg.cells_cfg.size(); i != e; ++i) {      //LNV - cells_cfg is a vector. I'm not sure what it represents.
